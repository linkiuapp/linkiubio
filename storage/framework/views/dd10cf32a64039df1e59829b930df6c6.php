...
<div <?php echo e($attributes); ?>>
    ...
    <?php if(count($totalOrders) > 0): ?>
        <div x-data="ordersTableWidget(<?php echo e(json_encode($totalOrders)); ?>, '<?php echo e($storeSlug); ?>', <?php echo e($perPage); ?>)"
...
document.addEventListener('alpine:init', () => {
    Alpine.data('ordersTableWidget', (orders, storeSlug, perPage = 10) => ({
        ...
        getStatusLabel(status) {
            const statuses = <?php echo json_encode(\App\Shared\Models\Order::STATUSES, 15, 512) ?>;
...
<?php /**PATH C:\laragon\www\Liniu_Final\app\Features/DesignSystem/Components/Dashboard/OrdersTableWidget.blade.php ENDPATH**/ ?>