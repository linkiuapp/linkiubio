...
<head>
    ...
    <title>Admin <?php echo e($store->name); ?> - Iniciar Sesión</title>
    
    <!-- Meta tags -->
    <meta name="description" content="Panel de administración para <?php echo e($store->name); ?>">
    ...
    <div class="min-h-screen flex" style="position: relative; z-index: 2;">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-slate-200">
            <div class="absolute inset-0">
                <img src="<?php echo e(asset('images-ui/banner_navidad_logens.webp')); ?>" 
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
            <div class="w-full max-w-md">
                ...
                <div class="mb-8 text-start">
                    <img src="<?php echo e(asset('images-ui/base_ui_login_logo.svg')); ?>" 
                    alt="Logo de Linkiu" 
                ...
                <!-- Formulario -->
                <form method="POST" action="<?php echo e(route('tenant.admin.login.submit', $store->slug)); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" 
                                   ...
                                   class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors <?php $__errorArgs = ['email'];
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" 
                                   id="password" 
                                   name="password" 
                                   class="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('tenant.admin.password.forgot', $store->slug)); ?>" 
                ...
                <div class="mt-4">
                    <a href="<?php echo e(route('register.step1')); ?>" 
                       class="w-full bg-white border-2 border-indigo-600 text-indigo-600 hover:bg-indigo-50 font-semibold py-3 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-md hover:shadow-lg">
...
<?php /**PATH C:\laragon\www\Liniu_Final\app\Features\TenantAdmin/Views/Core/auth/login.blade.php ENDPATH**/ ?>