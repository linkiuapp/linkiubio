<?php $__env->startSection('title', 'Editar Plan - ' . $plan->name); ?>
...
<div class="max-w-6xl mx-auto space-y-6 mt-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('superlinkiu.plans.index')); ?>" class="inline-flex items-center justify-center">
                <i data-lucide="arrow-left" class="w-5 h-5 text-gray-600 hover:text-gray-800"></i>
            </a>
            <div>
                <h1 class="text-lg font-semibold text-gray-800">Editar Plan: <?php echo e($plan->name); ?></h1>
    ...
    <form method="POST" action="<?php echo e(route('superlinkiu.plans.update', $plan)); ?>" enctype="multipart/form-data" 
...
unset($__errorArgs, $__bag); ?>"
                        placeholder="Describe las características principales del plan..."><?php echo e(old('description', $plan->description)); ?></textarea>
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <input 
                                    ...
                                    value="<?php echo e(old('discounts.quarterly', 5)); ?>"
                                    min="0" 
                                    max="100"
                                    step="1"
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <input 
                                    ...
                                    value="<?php echo e(old('discounts.semester', 10)); ?>"
                                    min="0" 
                                    max="100"
                                    step="1"
                                    class="w-20 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-center"
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <input 
                                    ...
                                    value="<?php echo e(old('discounts.annual', 15)); ?>"
                                    min="0" 
                                    max="100"
                                    step="1"
                                    class="w-20 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-center"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input 
                            ...
                            id="trial_days" 
                            name="trial_days" 
                            value="<?php echo e(old('trial_days', $plan->trial_days ?? 0)); ?>"
                            min="0"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div>
                            ...
                            <input type="number" name="max_products" value="<?php echo e(old('max_products', $plan->max_products)); ?>" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-800 mb-2">
                                Categorías <span class="text-red-500">*</span>
                            </label>
                            <input type="number" name="max_categories" value="<?php echo e(old('max_categories', $plan->max_categories)); ?>" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-800 mb-2">
                                Variables <span class="text-red-500">*</span>
                            </label>
                            <input type="number" name="max_variables" value="<?php echo e(old('max_variables', $plan->max_variables)); ?>" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        ...
                        <div>
                            ...
                            <input type="number" name="max_product_images" value="<?php echo e(old('max_product_images', $plan->max_product_images)); ?>" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="max_slider" value="<?php echo e(old('max_slider', $plan->max_slider)); ?>" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-800 mb-2">
                                Cupones Activos <span class="text-red-500">*</span>
                            </label>
                            <input type="number" name="max_active_coupons" value="<?php echo e(old('max_active_coupons', $plan->max_active_coupons)); ?>" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="max_sedes" value="<?php echo e(old('max_sedes', $plan->max_sedes)); ?>" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-800 mb-2">
                                Zonas de Reparto <span class="text-red-500">*</span>
                            </label>
                            <input type="number" name="max_delivery_zones" value="<?php echo e(old('max_delivery_zones', $plan->max_delivery_zones)); ?>" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="max_payment_methods" value="<?php echo e(old('max_payment_methods', $plan->max_payment_methods)); ?>" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-800 mb-2">
                                Cuentas Bancarias <span class="text-red-500">*</span>
                            </label>
                            <input type="number" name="max_bank_accounts" value="<?php echo e(old('max_bank_accounts', $plan->max_bank_accounts)); ?>" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div>
                            ...
                            <input type="number" name="max_admins" value="<?php echo e(old('max_admins', $plan->max_admins)); ?>" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-800 mb-2">
                                Tickets/Mes <span class="text-red-500">*</span>
                            </label>
                            <input type="number" name="max_tickets_per_month" value="<?php echo e(old('max_tickets_per_month', $plan->max_tickets_per_month)); ?>" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-800 mb-2">
                            ...
                            <div class="flex items-center gap-2">
                                <input type="number" name="order_history_months" value="<?php echo e(old('order_history_months', $plan->order_history_months)); ?>" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <input type="number" name="analytics_retention_days" value="<?php echo e(old('analytics_retention_days', $plan->analytics_retention_days)); ?>" min="30" step="30" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    ...
                    <div x-show="open" x-collapse class="p-4 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="max_tables" value="<?php echo e(old('max_tables', $plan->max_tables ?? 0)); ?>" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ...
                            <div>
                                ...
                                <input type="number" name="max_daily_reservations" value="<?php echo e(old('max_daily_reservations', $plan->max_daily_reservations ?? 0)); ?>" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <p class="mt-1 text-xs text-gray-600">0 = ilimitado</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div x-show="open" x-collapse class="p-4 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div>
                                ...
                                <input type="number" name="max_rooms" value="<?php echo e(old('max_rooms', $plan->max_rooms ?? 0)); ?>" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <p class="mt-1 text-xs text-gray-600">0 = ilimitado</p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-800 mb-2">
                                ...
                                <input type="number" name="max_room_types" value="<?php echo e(old('max_room_types', $plan->max_room_types ?? 0)); ?>" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ...
                            <div>
                                ...
                                <input type="number" name="max_tables" value="<?php echo e(old('max_tables', $plan->max_tables ?? 0)); ?>" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" disabled x-bind:disabled="true">
                            ...
                            <div>
                                ...
                                <input type="number" name="max_daily_hotel_reservations" value="<?php echo e(old('max_daily_hotel_reservations', $plan->max_daily_hotel_reservations ?? 0)); ?>" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <p class="mt-1 text-xs text-gray-600">0 = ilimitado</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="inventory_tracking" value="1" <?php echo e(old('inventory_tracking', $plan->inventory_tracking) ? 'checked' : ''); ?> class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" id="inventory_tracking">
                ...
                <div class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="whatsapp_integration" value="1" <?php echo e(old('whatsapp_integration', $plan->whatsapp_integration) ? 'checked' : ''); ?> class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" id="whatsapp_integration">
                ...
                <div class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="kiubot_enabled" value="1" <?php echo e(old('kiubot_enabled', $plan->kiubot_enabled) ? 'checked' : ''); ?> class="w-5 h-5 text-purple-600 border-gray-300 rounded focus:ring-2 focus:ring-purple-500" id="kiubot_enabled">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="support_level" id="support_level" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['support_level'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            <option value="basic" <?php echo e(old('support_level', $plan->support_level) == 'basic' ? 'selected' : ''); ?>>Básico - Correo, horario laboral</option>
                            <option value="priority" <?php echo e(old('support_level', $plan->support_level) == 'priority' ? 'selected' : ''); ?>>Prioritario - Correo + Chat, respuesta rápida</option>
                            <option value="premium" <?php echo e(old('support_level', $plan->support_level) == 'premium' ? 'selected' : ''); ?>>Premium - 24/7, atención personalizada</option>
                        </select>
                        <?php $__errorArgs = ['support_level'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            <input 
                                ...
                                value="<?php echo e(old('support_response_time', $plan->support_response_time)); ?>"
                                min="1"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['support_response_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <?php $__errorArgs = ['support_response_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="allow_custom_slug" value="1" <?php echo e(old('allow_custom_slug', $plan->allow_custom_slug) ? 'checked' : ''); ?> class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" id="allow_custom_slug">
                ...
                <div class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $plan->is_active) ? 'checked' : ''); ?> class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" id="is_active">
                ...
                <div class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="is_public" value="1" <?php echo e(old('is_public', $plan->is_public) ? 'checked' : ''); ?> class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" id="is_public">
                ...
                <div class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="is_featured" value="1" <?php echo e(old('is_featured', $plan->is_featured) ? 'checked' : ''); ?> class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" id="is_featured">
        ...
        <div class="flex items-center justify-end gap-3 py-4">
            <a href="<?php echo e(route('superlinkiu.plans.index')); ?>" class="px-6 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg font-medium transition-colors">
                Cancelar
            </a>
...
function planForm() {
    ...
    return {
        monthlyPrice: <?php echo e(old('price', $plan->price ?? 0)); ?>,
        quarterlyDiscount: <?php echo e(old('discounts.quarterly', $quarterlyDiscount)); ?>,
        semesterDiscount: <?php echo e(old('discounts.semester', $semesterDiscount)); ?>,
        annualDiscount: <?php echo e(old('discounts.annual', $annualDiscount)); ?>,
        features: <?php echo json_encode(old('features_list', $plan->features_list ?? []), 512) ?>,
...
<?php echo $__env->make('shared::layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Liniu_Final\app\Features\SuperLinkiu/Views/plans/edit.blade.php ENDPATH**/ ?>