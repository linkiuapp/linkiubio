    ...
    <div class="p-4 space-y-6">
                    ...
                    <div class="bg-white rounded-xl overflow-hidden">
                        ...
                        <div class="relative w-full h-32 rounded-t-xl overflow-hidden">
                            <?php if($mapUrl): ?>
                                ...
                                <a href="<?php echo e($navigationUrls['google_maps']); ?>" target="_blank" class="block w-full h-full">
                                    <img src="<?php echo e($mapUrl); ?>" 
                                         alt="Ubicación: <?php echo e($location->name); ?>" 
                                         class="w-full h-full object-cover cursor-pointer hover:opacity-90 transition-opacity">
                                </a>
                            <?php else: ?>
                                <!-- Placeholder clickeable -->
                                <a href="<?php echo e($navigationUrls['google_maps']); ?>" target="_blank" 
                            ...
                            <div class="absolute top-2 right-2 flex gap-2 z-10">
                                <!-- Botón Google Maps -->
                                <a 
                                    href="<?php echo e($navigationUrls['google_maps']); ?>" 
                                    target="_blank"
                                    @click.stop
                                ...
                                <!-- Botón Waze -->
                                <a 
                                    href="<?php echo e($navigationUrls['waze']); ?>" 
                                    target="_blank"
                                    @click.stop
                                    class="bg-white hover:bg-gray-50 text-gray-700 rounded-full p-2.5 shadow-lg border border-gray-200 transition-all hover:scale-110"
                        ...
                        <div class="p-4 space-y-3">
                            ...
                            <div class="flex items-center gap-2">
                                <h3 class="text-base font-bold text-slate-900"><?php echo e($location->name); ?></h3>
                            ...
                            <?php if($location->description): ?>
                                <p class="text-sm font-normal text-slate-700"><?php echo e($location->description); ?></p>
                            <?php endif; ?>
                            
                            <!-- Estado actual con badge -->
                            <?php if($location->currentStatus['status'] === 'open'): ?>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <p class="text-sm font-normal text-slate-900 flex-1">
                                    <?php echo e($location->address); ?><?php echo e($location->city || $location->department ? ', ' : ''); ?><?php echo e($location->city); ?><?php echo e($location->city && $location->department ? ', ' : ''); ?><?php echo e($location->department); ?>
                            ...
                            <?php if($location->manager_name): ?>
                                <div class="flex items-center gap-2">
                                    ...
                                    <p class="text-sm font-normal text-slate-900"><?php echo e($location->manager_name); ?></p>
                                </div>
                            <?php endif; ?>

                            <!-- Horarios en grid horizontal -->
                            <?php if($location->schedules->count() > 0): ?>
                                <?php
                                    $dayAbbreviations = ['Dom', 'Lun', 'Mar', 'Mie', 'Jue', 'Vie', 'Sab'];
                                    $currentDayOfWeek = \Carbon\Carbon::now()->dayOfWeek; // 0=Domingo, 6=Sábado
                                ?>
                                <div class="grid grid-cols-5 md:flex gap-2">
                                    <?php for($day = 0; $day < 7; $day++): ?>
                                        <?php
                                            $schedule = $location->schedules->where('day_of_week', $day)->first();
                                            $isToday = $day === $currentDayOfWeek;
                                        ?>
                                        <div class="flex-1 rounded-lg p-2 text-center <?php echo e($isToday ? 'bg-blue-100 border-2 border-blue-500' : 'bg-gray-100'); ?>">
                                            <?php if($schedule && !$schedule->is_closed): ?>
                                                <div class="space-y-0.5">
                                                    <!-- Horario principal -->
                                                    <div class="text-sm font-bold <?php echo e($isToday ? 'text-blue-900' : 'text-slate-900'); ?>">
                                                        <?php echo e(substr($schedule->open_time_1, 0, 5)); ?>

                                                    </div>
                                                    <!-- Horario adicional si existe -->
                                                    <?php if($schedule->hasAdditionalSchedule()): ?>
                                                        <div class="text-xs font-semibold <?php echo e($isToday ? 'text-blue-700' : 'text-slate-600'); ?>">
                                                            <?php echo e(substr($schedule->open_time_2, 0, 5)); ?>

                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                                            <?php else: ?>
                                                <div class="text-sm font-bold <?php echo e($isToday ? 'text-blue-900' : 'text-slate-900'); ?>">-</div>
                                            <?php endif; ?>
                                            <div class="text-xs font-normal mt-1 <?php echo e($isToday ? 'text-blue-800 font-semibold' : 'text-slate-700'); ?>">
                                                <?php echo e($dayAbbreviations[$day]); ?>
                            ...
                            <!-- Redes sociales -->
                            <?php if($location->socialLinks->count() > 0): ?>
                                <div class="pt-3">
                                    <p class="text-xs text-slate-900 mb-2">Síguenos</p>
                                    <div class="flex gap-2">
                                        <?php $__currentLoopData = $location->socialLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e($social->url); ?>" 
                                               ...
                                               class="w-12 h-12 bg-brandPrimary-50 rounded-lg flex items-center justify-center transition-colors">
                                                ...
                                                <?php elseif($social->platform === 'tiktok'): ?>
                                                <lord-icon
                                                ...
                                                <?php elseif($social->platform === 'linkiu'): ?>
                                                <lord-icon
        ...
        <?php else: ?>
            ...
            <div class="bg-accent-50 rounded-xl p-8 text-center flex flex-col items-center justify-center border border-accent-200">
                ...
                <?php if($store->phone || $store->email): ?>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Liniu_Final\app\Features\Tenant/Views/storefront/contact.blade.php ENDPATH**/ ?>