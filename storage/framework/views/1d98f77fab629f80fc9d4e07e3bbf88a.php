...
<div id="<?php echo e($uniqueId); ?>" 
     data-hs-file-upload='<?php echo $config; ?>'
     data-name="<?php echo e($name); ?>"
     data-max-size="<?php echo e($maxFileSize); ?>">
            ...
            <div class="mb-1 flex justify-between items-center">
                <div class="flex items-center gap-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-red-500" style="display: none;" data-hs-file-upload-file-error="">El archivo excede el límite de tamaño de <?php echo e($maxFileSize); ?>MB.</p>
                    </div>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Tooltips.TooltipTop','data' => ['text' => 'Por favor intenta subir un archivo menor a '.e($maxFileSize).'MB.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['text' => 'Por favor intenta subir un archivo menor a '.e($maxFileSize).'MB.']); ?>
    ...
    <div class="cursor-pointer p-12 flex justify-center bg-white border border-dashed border-gray-300 rounded-xl hover:bg-gray-50 transition-colors" data-hs-file-upload-trigger="">
        <div class="text-center">
            ...
            <div class="mt-4 flex flex-wrap justify-center text-sm/6 text-gray-600">
                ...
                <span class="bg-white font-semibold text-blue-600 hover:text-blue-700 rounded-lg decoration-2 hover:underline focus-within:outline-hidden focus-within:ring-2 focus-within:ring-blue-600 focus-within:ring-offset-2"><?php echo e($browseText); ?></span>
            </div>

            <p class="mt-1 text-xs text-gray-400">
                <?php echo e($helpText ?: "Selecciona un archivo de hasta {$maxFileSize}MB."); ?>
...
(function() {
    ...
    const inputName = '<?php echo e($name); ?>';
    const maxFileSize = <?php echo e($maxFileSize); ?>;
    const minWidth = <?php echo e($minWidth ?? 'null'); ?>;
    const minHeight = <?php echo e($minHeight ?? 'null'); ?>;
    const requiredWidth = <?php echo e($requiredWidth ?? 'null'); ?>;
    const requiredHeight = <?php echo e($requiredHeight ?? 'null'); ?>;
    ...
    function setupDropzoneHandlers(instance, container) {
        ...
        if (!hiddenInput) {
            ...
            hiddenInput.setAttribute('accept', '<?php echo e($accept); ?>');
...
<?php /**PATH C:\laragon\www\Liniu_Final\app\Features/DesignSystem/Components/FileUploads/FileUploadWithValidation.blade.php ENDPATH**/ ?>