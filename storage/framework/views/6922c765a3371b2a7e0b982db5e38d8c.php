...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Sidebar.SidebarContentPush','data' => ['sidebarId' => 'tenant-admin-sidebar','items' => $sidebarItems,'footer' => $footer,'showToggle' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['sidebar-id' => 'tenant-admin-sidebar','items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($sidebarItems),'footer' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($footer),'show-toggle' => true]); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Liniu_Final\app\Shared/Views/Components/admin/tenant-sidebar.blade.php ENDPATH**/ ?>