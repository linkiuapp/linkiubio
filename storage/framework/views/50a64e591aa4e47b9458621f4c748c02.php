...
<?php $__env->startSection('title', 'Nuevo Pedido'); ?>
...
<?php endif; ?>
    ...
    <form action="<?php echo e(route('tenant.admin.orders.store', $store->slug)); ?>" method="POST" enctype="multipart/form-data" @submit="validateForm" class="space-y-6">
        <?php echo csrf_field(); ?>
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                    ...
                    <ul class="mt-2 text-sm text-red-700 list-disc list-inside space-y-1">
                        <?php $__currentLoopData = $errors->get('stock'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stockErrors): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(is_array($stockErrors)): ?>
                                <?php $__currentLoopData = $stockErrors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><?php echo e($error); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                                <li><?php echo e($stockErrors); ?></li>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors">
                            <input type="radio" 
                                   name="delivery_type" 
                                   value="pickup" 
                                   <?php echo e(old('delivery_type') === 'pickup' ? 'checked' : ''); ?>
                        ...
                        <div>
                            <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors">
                                <input type="radio" 
                                       name="delivery_type" 
                                       value="local" 
                                       <?php echo e(old('delivery_type') === 'local' ? 'checked' : ''); ?>
                                ...
                                <div class="mt-3 ml-7 space-y-3">
                                    <div>
                                        ...
                                        <textarea id="customer_address_local" 
                                                  ...
                                                  placeholder="Dirección completa, barrio, referencias"><?php echo e(old('customer_address')); ?></textarea>
                                    </div>
                                </div>
                            </template>
                        </div>
                        ...
                        <div>
                            <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors">
                                <input type="radio" 
                                       name="delivery_type" 
                                       value="national" 
                                       <?php echo e(old('delivery_type') === 'national' ? 'checked' : ''); ?>
                        ...
                        <?php if(!$simpleShipping || (!$simpleShipping->pickup_enabled && !$simpleShipping->local_enabled && !$simpleShipping->national_enabled)): ?>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-xs text-yellow-700 mt-1">
                                        ...
                                        <a href="<?php echo e(route('tenant.admin.simple-shipping.index', $store->slug)); ?>" class="underline text-blue-600 hover:text-blue-700">
                                            Configurar ahora
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="space-y-3">
                        <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors">
                            <input type="radio" 
                                   name="payment_method" 
                                   value="transferencia" 
                                   <?php echo e(old('payment_method') === 'transferencia' ? 'checked' : ''); ?>
                        ...
                        <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors">
                            <input type="radio" 
                                   ...
                                   <?php echo e(old('payment_method') === 'contra_entrega' ? 'checked' : ''); ?>
                        ...
                        <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-100 cursor-pointer transition-colors" x-show="deliveryType === 'pickup'">
                            <input type="radio" 
                                   name="payment_method" 
                                   value="efectivo" 
                                   <?php echo e(old('payment_method') === 'efectivo' ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
            ...
            <textarea name="notes" 
                      ...
                      placeholder="Instrucciones especiales, observaciones, etc."><?php echo e(old('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex gap-3 justify-end">
            <a href="<?php echo e(route('tenant.admin.orders.index', $store->slug)); ?>" class="px-4 py-2 border-2 border-error-300 text-error-300 rounded-lg hover:bg-error-100 transition-colors">
                Cancelar
            </a>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('orderCreate', () => ({
        // Datos
        deliveryType: '<?php echo e(old("delivery_type")); ?>',
        paymentMethod: '<?php echo e(old("payment_method")); ?>',
        selectedDepartment: '',
        selectedCity: '',
        selectedShippingZone: '',
        shippingCost: 0,
        products: <?php echo json_encode($products, 15, 512) ?>,
        shippingMethods: <?php echo json_encode($shippingZones ?? [], 15, 512) ?>,
        simpleShipping: <?php echo json_encode($simpleShippingData ?? null, 15, 512) ?>,
        orderItems: [],
        subtotal: 0,
        total: 0,
...
<?php endif; ?> <?php /**PATH C:\laragon\www\Liniu_Final\app\Features\TenantAdmin/Views/Core/orders/create.blade.php ENDPATH**/ ?>