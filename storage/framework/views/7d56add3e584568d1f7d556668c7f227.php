                ...
                <?php else: ?>
                    <div class="bg-brandInfo-50 border border-brandInfo-300 rounded-lg p-4">
                        <p class="caption text-brandInfo-300 flex items-center">
                            ...
                            Esta tienda no ha configurado su <?php echo e(strtolower($section['title'])); ?> aún.
                        </p>
                    </div>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Liniu_Final\app\Features\Tenant/Views/pages/legal-policies.blade.php ENDPATH**/ ?>