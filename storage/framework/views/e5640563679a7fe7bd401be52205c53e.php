...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Editar Slider'); ?>

    <?php $__env->startSection('content'); ?>
    <div
        class="max-w-4xl mx-auto"
        x-data="(() => ({
            isScheduled: <?php echo e(json_encode((bool) old('is_scheduled', $slider->is_scheduled))); ?>,
            isPermanent: <?php echo e(json_encode((bool) old('is_permanent', $slider->is_permanent))); ?>,
            urlType: <?php echo e(json_encode(old('url_type', $slider->url_type ?? 'none'))); ?>,
            urlValue: <?php echo e(json_encode(old('url', $slider->url))); ?>,
            selectedInternalLabel: <?php echo e(json_encode(old('url_type', $slider->url_type ?? 'none') === 'internal' ? old('url', $slider->url) : '')); ?>,
            suggestions: [],
...
<?php endif; ?>
                ...
                <h1 class="text-lg font-semibold text-gray-800">Editar Slider</h1>
            </div>
        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Alerts.AlertSoft','data' => ['type' => 'info','message' => 'Estás usando '.e($currentCount).' de '.e($maxSliders).' sliders disponibles en tu plan '.e($store->plan->name).'.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'info','message' => 'Estás usando '.e($currentCount).' de '.e($maxSliders).' sliders disponibles en tu plan '.e($store->plan->name).'.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['size' => 'lg','shadow' => 'sm']); ?>
            <form action="<?php echo e(route('tenant.admin.sliders.update', [$store->slug, $slider->id])); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Nombre','name' => 'name','placeholder' => 'Promoción Navidad 2024','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('name', $slider->name)),'required' => true,'container-class' => 'w-full','class' => 'border border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-6">
                        ...
                        ><?php echo e(old('description', $slider->description)); ?></textarea>
                    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Switches.SwitchBasic','data' => ['switchName' => 'is_active','checked' => old('is_active', $slider->is_active),'switchId' => 'is_active','value' => '1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['switch-name' => 'is_active','checked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('is_active', $slider->is_active)),'switch-id' => 'is_active','value' => '1']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    <?php if($slider->image_path): ?>
                        <p class="text-xs text-gray-500 mt-3">Imagen actual:</p>
                        <img src="<?php echo e(Storage::disk('public')->url($slider->image_path)); ?>" alt="Imagen actual del slider" class="h-40 rounded-lg mt-2 border border-gray-200 object-cover">
                        <p class="text-xs text-gray-500 mt-2">Deja el campo vacío para mantener la imagen actual.</p>
                    <?php endif; ?>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="mb-6 space-y-3">
                        <label class="block text-sm font-medium text-gray-700">Tipo de enlace</label>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Radios.RadioBasic','data' => ['radioName' => 'url_type','label' => 'Sin enlace','checked' => old('url_type', $slider->url_type) == 'none','radioId' => 'url_type_none','value' => 'none','xOn:change' => 'setUrlType(\'none\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['radio-name' => 'url_type','label' => 'Sin enlace','checked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('url_type', $slider->url_type) == 'none'),'radio-id' => 'url_type_none','value' => 'none','x-on:change' => 'setUrlType(\'none\')']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginal3f698e1eb1ec3d65607261c560621fc6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3f698e1eb1ec3d65607261c560621fc6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Radios.RadioBasic','data' => ['radioName' => 'url_type','label' => 'Enlace interno','checked' => old('url_type', $slider->url_type) == 'internal','radioId' => 'url_type_internal','value' => 'internal','xOn:change' => 'setUrlType(\'internal\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('radio-basic'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['radio-name' => 'url_type','label' => 'Enlace interno','checked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('url_type', $slider->url_type) == 'internal'),'radio-id' => 'url_type_internal','value' => 'internal','x-on:change' => 'setUrlType(\'internal\')']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3f698e1eb1ec3d65607261c560621fc6)): ?>
<?php $attributes = $__attributesOriginal3f698e1eb1ec3d65607261c560621fc6; ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginal3f698e1eb1ec3d65607261c560621fc6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3f698e1eb1ec3d65607261c560621fc6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Radios.RadioBasic','data' => ['radioName' => 'url_type','label' => 'Enlace externo','checked' => old('url_type', $slider->url_type) == 'external','radioId' => 'url_type_external','value' => 'external','xOn:change' => 'setUrlType(\'external\')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('radio-basic'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['radio-name' => 'url_type','label' => 'Enlace externo','checked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('url_type', $slider->url_type) == 'external'),'radio-id' => 'url_type_external','value' => 'external','x-on:change' => 'setUrlType(\'external\')']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3f698e1eb1ec3d65607261c560621fc6)): ?>
<?php $attributes = $__attributesOriginal3f698e1eb1ec3d65607261c560621fc6; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Inputs.InputWithIcon','data' => ['name' => 'url','icon' => 'link','placeholder' => 'https://ejemplo.com o /categoria/ropa','value' => old('url', $slider->url),'xModel' => 'urlValue','xRef' => 'urlInput','xOn:input' => 'handleUrlInput($event.target.value)','xOn:focus' => 'handleUrlFocus()','xOn:keydown.arrowDown.prevent' => 'highlightNextSuggestion()','xOn:keydown.arrowUp.prevent' => 'highlightPreviousSuggestion()','xOn:keydown.enter.prevent' => 'selectHighlightedSuggestion()','xOn:keydown.escape' => 'closeSuggestions()','xBind:disabled' => 'isUrlDisabled','xBind:class' => 'isUrlDisabled ? \'bg-gray-100 cursor-not-allowed\' : \'bg-white\'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'url','icon' => 'link','placeholder' => 'https://ejemplo.com o /categoria/ropa','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('url', $slider->url)),'x-model' => 'urlValue','x-ref' => 'urlInput','x-on:input' => 'handleUrlInput($event.target.value)','x-on:focus' => 'handleUrlFocus()','x-on:keydown.arrow-down.prevent' => 'highlightNextSuggestion()','x-on:keydown.arrow-up.prevent' => 'highlightPreviousSuggestion()','x-on:keydown.enter.prevent' => 'selectHighlightedSuggestion()','x-on:keydown.escape' => 'closeSuggestions()','x-bind:disabled' => 'isUrlDisabled','x-bind:class' => 'isUrlDisabled ? \'bg-gray-100 cursor-not-allowed\' : \'bg-white\'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                ...
                <div class="mb-8">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center gap-3">
                            <?php if (isset($component)) { $__componentOriginal1131acd2b56c97b61455de948c6a2e41 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1131acd2b56c97b61455de948c6a2e41 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Switches.SwitchBasic','data' => ['switchName' => 'is_scheduled','checked' => old('is_scheduled', $slider->is_scheduled),'switchId' => 'is_scheduled','value' => '1','xModel' => 'isScheduled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('switch-basic'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['switch-name' => 'is_scheduled','checked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('is_scheduled', $slider->is_scheduled)),'switch-id' => 'is_scheduled','value' => '1','x-model' => 'isScheduled']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1131acd2b56c97b61455de948c6a2e41)): ?>
<?php $attributes = $__attributesOriginal1131acd2b56c97b61455de948c6a2e41; ?>
...
<?php endif; ?>
                    ...
                    <div x-show="isScheduled" x-cloak style="display: none;" class="space-y-6">
                        <div class="flex items-center gap-3">
                            ...
                            <?php if (isset($component)) { $__componentOriginal1131acd2b56c97b61455de948c6a2e41 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1131acd2b56c97b61455de948c6a2e41 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Switches.SwitchBasic','data' => ['switchName' => 'is_permanent','checked' => old('is_permanent', $slider->is_permanent),'switchId' => 'is_permanent','value' => '1','xModel' => 'isPermanent']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('switch-basic'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['switch-name' => 'is_permanent','checked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('is_permanent', $slider->is_permanent)),'switch-id' => 'is_permanent','value' => '1','x-model' => 'isPermanent']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1131acd2b56c97b61455de948c6a2e41)): ?>
<?php $attributes = $__attributesOriginal1131acd2b56c97b61455de948c6a2e41; ?>
...
<?php endif; ?>
                        ...
                        <div x-show="!isPermanent" x-cloak style="display: none;" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <?php if (isset($component)) { $__componentOriginalc088a413751f2bc7a99da19699d0dd5c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc088a413751f2bc7a99da19699d0dd5c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Inputs.InputWithLabel','data' => ['label' => 'Fecha inicio','name' => 'start_date','type' => 'date','value' => old('start_date', optional($slider->start_date)->toDateString())]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-with-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Fecha inicio','name' => 'start_date','type' => 'date','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('start_date', optional($slider->start_date)->toDateString()))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc088a413751f2bc7a99da19699d0dd5c)): ?>
<?php $attributes = $__attributesOriginalc088a413751f2bc7a99da19699d0dd5c; ?>
...
<?php endif; ?>
                            ...
                            <div>
                                <?php if (isset($component)) { $__componentOriginalc088a413751f2bc7a99da19699d0dd5c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc088a413751f2bc7a99da19699d0dd5c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Inputs.InputWithLabel','data' => ['label' => 'Fecha fin','name' => 'end_date','type' => 'date','value' => old('end_date', optional($slider->end_date)->toDateString())]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-with-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Fecha fin','name' => 'end_date','type' => 'date','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('end_date', optional($slider->end_date)->toDateString()))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc088a413751f2bc7a99da19699d0dd5c)): ?>
<?php $attributes = $__attributesOriginalc088a413751f2bc7a99da19699d0dd5c; ?>
...
<?php endif; ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <?php if (isset($component)) { $__componentOriginalc088a413751f2bc7a99da19699d0dd5c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc088a413751f2bc7a99da19699d0dd5c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Inputs.InputWithLabel','data' => ['label' => 'Hora inicio','name' => 'start_time','type' => 'time','value' => old('start_time', optional($slider->start_time)->format('H:i'))]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-with-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Hora inicio','name' => 'start_time','type' => 'time','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('start_time', optional($slider->start_time)->format('H:i')))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc088a413751f2bc7a99da19699d0dd5c)): ?>
<?php $attributes = $__attributesOriginalc088a413751f2bc7a99da19699d0dd5c; ?>
...
<?php endif; ?>
                            ...
                            <div>
                                <?php if (isset($component)) { $__componentOriginalc088a413751f2bc7a99da19699d0dd5c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc088a413751f2bc7a99da19699d0dd5c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Inputs.InputWithLabel','data' => ['label' => 'Hora fin','name' => 'end_time','type' => 'time','value' => old('end_time', optional($slider->end_time)->format('H:i'))]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-with-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Hora fin','name' => 'end_time','type' => 'time','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('end_time', optional($slider->end_time)->format('H:i')))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc088a413751f2bc7a99da19699d0dd5c)): ?>
<?php $attributes = $__attributesOriginalc088a413751f2bc7a99da19699d0dd5c; ?>
                                ...
                                <?php $__currentLoopData = ['monday' => 'L', 'tuesday' => 'M', 'wednesday' => 'X', 'thursday' => 'J', 'friday' => 'V', 'saturday' => 'S', 'sunday' => 'D']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="flex items-center justify-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors has-[:checked]:bg-blue-50 has-[:checked]:border-blue-500">
                                        <input type="checkbox" 
                                               ...
                                               value="1" 
                                               <?php echo e(old("scheduled_days.{$day}", $slider->scheduled_days[$day] ?? false) ? 'checked' : ''); ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal30e169a586a2bd405d6a25d5afef85c0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal30e169a586a2bd405d6a25d5afef85c0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Buttons.ButtonIcon','data' => ['type' => 'solid','color' => 'dark','icon' => 'save','text' => 'Guardar Cambios','htmlType' => 'submit']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'solid','color' => 'dark','icon' => 'save','text' => 'Guardar Cambios','html-type' => 'submit']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal30e169a586a2bd405d6a25d5afef85c0)): ?>
<?php $attributes = $__attributesOriginal30e169a586a2bd405d6a25d5afef85c0; ?>
...
<?php endif; ?> <?php /**PATH C:\laragon\www\Liniu_Final\app\Features\TenantAdmin/Views/Core/sliders/edit.blade.php ENDPATH**/ ?>