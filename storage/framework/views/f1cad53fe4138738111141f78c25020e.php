...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-7xl mx-auto space-y-6">
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if (!tourCompleted) {
                        const shouldAutoStart = sessionStorage.getItem('auto_start_create_category_tour') === '1' || 
                                              <?php echo e(($totalCategories ?? 0) === 0 ? 'true' : 'false'); ?>;
        ...
        <div class="bg-blue-50 border border-blue-200 text-blue-800 text-sm rounded-lg px-4 py-3" role="alert" data-tour="consumo">
            Estás usando <strong><?php echo e($totalCategories); ?> de <?php echo e($categoryLimit); ?></strong> categorías disponibles en tu plan <?php echo e(e($store->plan->name)); ?>.<?php if($parentCategories->count() > 0): ?> Crear una subcategoría también cuenta para el límite.<?php endif; ?>
        </div>
        

        
        <form action="<?php echo e(route('tenant.admin.categories.store', $store->slug)); ?>" method="POST">
            <?php echo csrf_field(); ?>
                                ...
                                <?php $__currentLoopData = $icons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    >
                                        <input 
                                            ...
                                            class="sr-only peer"
                                            <?php echo e((old('icon_id') == $icon->id) ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                            <p class="mt-2 text-xs text-gray-500">
                                URL: <?php echo e(config('app.url')); ?>/<?php echo e(e($store->slug)); ?>/categoria/<span id="slug-preview">slug</span>
                            </p>
                        </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\Liniu_Final\app\Features\TenantAdmin/Views/Core/categories/create.blade.php ENDPATH**/ ?>