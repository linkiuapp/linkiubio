...
<div x-data="masterKeyModal('<?php echo e($uniqueId); ?>', '<?php echo e($action); ?>', '<?php echo e($actionLabel); ?>', '<?php echo e($storeSlug); ?>')" 
     x-init="init()">
        ...
        >
            ...
            >
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <div>
                            <label for="<?php echo e($uniqueId); ?>-key" class="block text-sm font-medium text-gray-700 mb-2">
                                Clave Maestra
                            </label>
                            <input 
                                type="password"
                                id="<?php echo e($uniqueId); ?>-key"
                                x-model="masterKey"
...
<?php /**PATH C:\laragon\www\Liniu_Final\app\Features/DesignSystem/Components/Modals/ModalMasterKey.blade.php ENDPATH**/ ?>