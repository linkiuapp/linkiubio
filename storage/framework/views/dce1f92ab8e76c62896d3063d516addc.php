...
<div id="cart-float" class="fixed bottom-4 left-1/2 transform -translate-x-1/2 w-[360px] h-[88px] sm:w-[480px] bg-slate-900 rounded-full shadow-xl z-[1000] px-3 py-2 sm:px-4 sm:py-3 flex items-center">
    <div class="flex items-center justify-between gap-2 sm:gap-3 w-full">
        ...
        <div class="relative flex-shrink-0">
            ...
            <img src="<?php echo e(asset('images-ui/emoji_toast_Linkiu_shop.svg')); ?>" alt="Emoji Linkiu Shop" class="w-16 h-16 object-cover">
            <!-- Badge contador -->
        ...
        <div class="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
            <a href="<?php echo e(route('tenant.cart.index', $store->slug ?? 'store')); ?>"
...
</script> <?php /**PATH C:\laragon\www\Liniu_Final\resources\views/components/cart-float.blade.php ENDPATH**/ ?>