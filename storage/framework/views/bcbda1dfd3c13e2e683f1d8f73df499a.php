...
<div class="bg-white rounded-lg shadow-sm overflow-hidden">
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200" 
                   x-data="ordersTable(<?php echo \Illuminate\Support\Js::from($orders->getCollection()->map(function($order) {
                       return [
                           'id' => $order->id,
                   ...
                   })->values()->toArray())->toHtml() ?>, '<?php echo e($store->slug); ?>')">
    ...
    <?php if($orders->isEmpty()): ?>
        <div class="text-center py-12">
            ...
            <?php if(request()->hasAny(['status', 'order_type', 'payment_method', 'search', 'date_from', 'date_to', 'amount_from', 'amount_to'])): ?>
...
<?php /**PATH C:\laragon\www\Liniu_Final\app\Features/DesignSystem/Components/Orders/OrdersTable.blade.php ENDPATH**/ ?>