...
<?php $__env->startSection('content'); ?>
    <div class="max-w-2xl mx-auto px-4 py-6 space-y-6 relative z-0" data-order-id="<?php echo e($order->id); ?>">
        <!-- Slider de banners -->
        <div class="relative overflow-hidden rounded-lg" x-data="bannerSlider()">
            <div class="flex"
                ...
                <a href="<?php echo e(route('register.step1')); ?>" class="flex-shrink-0 w-full flex items-center justify-center relative">
                    <img src="<?php echo e(asset('images-ui/Banner_succces_linkiu_02.svg')); ?>" alt="Banner 2" class="w-full">
                </a>
                <!-- Slides originales -->
                <a href="<?php echo e(route('register.step1')); ?>" class="flex-shrink-0 w-full flex items-center justify-center relative">
                    <img src="<?php echo e(asset('images-ui/Banner_succces_linkiu_01.svg')); ?>" alt="Banner 1" class="w-full">
                </a>
                <a href="<?php echo e(route('register.step1')); ?>" class="flex-shrink-0 w-full flex items-center justify-center relative">
                    <img src="<?php echo e(asset('images-ui/Banner_succces_linkiu_02.svg')); ?>" alt="Banner 2" class="w-full">
                </a>
                ...
                <div class="px-4 pb-4">
                    ...
                    <div class="flex items-center justify-center w-full pt-6 pb-4">
                        <div class="flex bg-green-100 rounded-full relative items-center justify-center py-2 px-4 mx-auto gap-4">
                            <p class="text-lg font-bold text-green-900 tracking-wider" id="order-code"><?php echo e($order->order_number ?? 'N/A'); ?></p>
                        ...
                        <div class="space-y-4 px-4 pt-4">
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-sm font-normal text-gray-900"><?php echo e($order->customer_name ?? 'N/A'); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm font-normal text-gray-600">Teléfono:</span>
                                    <span class="text-sm font-normal text-gray-900"><?php echo e($order->customer_phone ?? 'N/A'); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                <?php if(($order->delivery_type ?? '') === 'domicilio'): ?>
                                    <div class="flex justify-between">
                                        ...
                                        <span class="text-sm font-normal text-gray-900 text-right"><?php echo e($order->customer_address ?? 'N/A'); ?></span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-sm font-normal text-gray-600">Ciudad:</span>
                                        <span class="text-sm font-normal text-gray-900"><?php echo e($order->city ?? 'N/A'); ?></span>
                                    </div>
                                <?php else: ?>
                                    <div class="flex justify-between">
                                        <span class="text-sm font-normal text-gray-600">Dirección tienda:</span>
                                        <span class="text-sm font-normal text-gray-900 text-right"><?php echo e($store->address ?? 'Ver en Google Maps'); ?></span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-sm font-normal text-gray-600">Horario:</span>
                                        <span class="text-sm font-normal text-gray-900"><?php echo e($store->schedule ?? 'Lun-Vie 9am-6pm'); ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>
                            <!-- Resumen de pago -->
                            ...
                            <div class="space-y-2">
                                ...
                                <?php if((($order->payment_method ?? '') === 'efectivo' || ($order->payment_method ?? '') === 'cash') && isset($order->cash_amount)): ?>
                                    <div class="flex justify-between">
                                        ...
                                        <span class="text-sm font-normal text-gray-900">$<?php echo e(number_format($order->cash_amount, 0, ',', '.')); ?></span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-sm font-normal text-gray-600">Tu cambio:</span>
                                        <span class="text-sm font-normal text-gray-900">$<?php echo e(number_format($order->cash_amount - $order->total, 0, ',', '.')); ?></span>
                                    </div>
                                <?php endif; ?>
                                <div class="border-t border-accent-200 pt-2">
                                    <div class="flex justify-between items-center">
                                        <span class="text-sm font-normal text-gray-600">Total:</span>
                                        <span class="text-sm font-bold text-gray-900">$<?php echo e(number_format($order->total ?? 0, 0, ',', '.')); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
const DELIVERY_TYPE = '<?php echo e($order->delivery_type ?? 'domicilio'); ?>';
