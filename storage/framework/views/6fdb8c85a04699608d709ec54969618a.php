...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Nueva Variable'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Alerts.AlertSoft','data' => ['type' => 'info','message' => 'Estás usando ' . $totalVariables . ' de ' . $variableLimit . ' variables disponibles en tu plan ' . $store->plan->name . '.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'info','message' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Estás usando ' . $totalVariables . ' de ' . $variableLimit . ' variables disponibles en tu plan ' . $store->plan->name . '.')]); ?>
...
<?php endif; ?>
        ...
        <form action="<?php echo e(route('tenant.admin.variables.store', $store->slug)); ?>" method="POST" x-data="variableForm()">
            <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Inputs.TextInput','data' => ['type' => 'text','name' => 'name','id' => 'name','label' => 'Nombre de la Variable','placeholder' => 'Ej: Talla, Color, Material','value' => old('name'),'required' => true,'error' => $errors->first('name'),'dataTour' => 'variable-name']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'name','id' => 'name','label' => 'Nombre de la Variable','placeholder' => 'Ej: Talla, Color, Material','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('name')),'required' => true,'error' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->first('name')),'data-tour' => 'variable-name']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Selects.SelectBasic','data' => ['name' => 'type','selectId' => 'type','options' => [
                                    ...
                                    'text' => 'Texto libre',
                                    'numeric' => 'Numérico'
                                ],'selected' => old('type', ''),'placeholder' => '','xModel' => 'variableType','@change' => 'handleTypeChange()','error' => $errors->first('type'),'required' => true,'dataTour' => 'variable-type']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['name' => 'type','select-id' => 'type','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                                    ...
                                    'text' => 'Texto libre',
                                    'numeric' => 'Numérico'
                                ]),'selected' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('type', '')),'placeholder' => '','x-model' => 'variableType','@change' => 'handleTypeChange()','error' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->first('type')),'required' => true,'data-tour' => 'variable-type']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Switches.SwitchBasic','data' => ['switchName' => 'is_required_default','checked' => old('is_required_default', false),'value' => '1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['switch-name' => 'is_required_default','checked' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('is_required_default', false)),'value' => '1']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    >
                        ...
                        <div>
                            <?php if (isset($component)) { $__componentOriginal23908c4dcfbc7bed00e0fcf18a7b6712 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal23908c4dcfbc7bed00e0fcf18a7b6712 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Inputs.TextInput','data' => ['type' => 'number','name' => 'min_value','id' => 'min_value','label' => 'Valor Mínimo','placeholder' => '0.00','value' => old('min_value'),'step' => '0.01','error' => $errors->first('min_value')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ds.text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'number','name' => 'min_value','id' => 'min_value','label' => 'Valor Mínimo','placeholder' => '0.00','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('min_value')),'step' => '0.01','error' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->first('min_value'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal23908c4dcfbc7bed00e0fcf18a7b6712)): ?>
<?php $attributes = $__attributesOriginal23908c4dcfbc7bed00e0fcf18a7b6712; ?>
...
<?php endif; ?>
                        ...
                        <div>
                            <?php if (isset($component)) { $__componentOriginal23908c4dcfbc7bed00e0fcf18a7b6712 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal23908c4dcfbc7bed00e0fcf18a7b6712 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Inputs.TextInput','data' => ['type' => 'number','name' => 'max_value','id' => 'max_value','label' => 'Valor Máximo','placeholder' => '100.00','value' => old('max_value'),'step' => '0.01','error' => $errors->first('max_value')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ds.text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'number','name' => 'max_value','id' => 'max_value','label' => 'Valor Máximo','placeholder' => '100.00','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('max_value')),'step' => '0.01','error' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->first('max_value'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal23908c4dcfbc7bed00e0fcf18a7b6712)): ?>
<?php $attributes = $__attributesOriginal23908c4dcfbc7bed00e0fcf18a7b6712; ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal30e169a586a2bd405d6a25d5afef85c0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal30e169a586a2bd405d6a25d5afef85c0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'design-system::Buttons.ButtonIcon','data' => ['type' => 'solid','color' => 'dark','icon' => 'check','size' => 'md','text' => 'Crear Variable','htmlType' => 'submit','dataTour' => 'save-button']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'solid','color' => 'dark','icon' => 'check','size' => 'md','text' => 'Crear Variable','html-type' => 'submit','data-tour' => 'save-button']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal30e169a586a2bd405d6a25d5afef85c0)): ?>
<?php $attributes = $__attributesOriginal30e169a586a2bd405d6a25d5afef85c0; ?>
...
<?php endif; ?>
    ...
    <script>
        function variableForm() {
            ...
            return {
                variableType: <?php echo json_encode(old('type', ''), 512) ?>,
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Liniu_Final\app\Features\TenantAdmin/Views/Core/variables/create.blade.php ENDPATH**/ ?>