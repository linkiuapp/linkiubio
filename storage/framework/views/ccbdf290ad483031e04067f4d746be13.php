    ...
    <div class="max-w-[375px] md:max-w-[400px] mx-auto px-6 py-8">
        ...
        <div class="text-center space-y-2">
            ...
            <p class="caption text-brandNeutral-400">
                © <?php echo e(date('Y')); ?> Todos los derechos reservados<br> Desarrollado por <span class="body-lg-bold text-brandPrimary-400"><a href="https://linkiu.bio" target="_blank">Linkiu S.A.S</a></span>
            </p>
        </div>
    </div>
</footer>
