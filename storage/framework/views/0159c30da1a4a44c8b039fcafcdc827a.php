                                ...
                                <div class="flex items-center gap-1.5 w-fit md:mb-0 mb-1">
                                    ...
                                    <?php if($relatedProduct->categories->count() > 0): ?>
                                        <div class="flex flex-wrap gap-1">
                                            <?php $__currentLoopData = $relatedProduct->categories->take(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
