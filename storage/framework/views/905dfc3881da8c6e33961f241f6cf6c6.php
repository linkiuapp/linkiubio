...
<select 
    ...
    class="py-3 px-4 pe-9 block w-full border border-gray-400 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none <?php echo e($attributes->get('class')); ?>"
...
>
    ...
    <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $labelOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(is_array($labelOption)): ?>
            <optgroup label="<?php echo e($value); ?>">
                <?php $__currentLoopData = $labelOption; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optValue => $optLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($optValue); ?>" <?php if($selected == $optValue): ?> selected <?php endif; ?>><?php echo e($optLabel); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </optgroup>
        <?php else: ?>
            <option value="<?php echo e(is_numeric($value) ? $labelOption : $value); ?>" <?php if($selected == (is_numeric($value) ? $labelOption : $value)): ?> selected <?php endif; ?>>
...
<?php /**PATH C:\laragon\www\Liniu_Final\app\Features/DesignSystem/Components/Selects/SelectWithLabel.blade.php ENDPATH**/ ?>