        ...
        <?php else: ?>
            <li class="page-item">
                <a class="page-link bg-accent-50 border border-accent-200 text-black-400 font-medium rounded-lg px-3 py-2 flex items-center justify-center h-[40px] hover:bg-primary-50 hover:border-primary-200 hover:text-primary-400 transition-colors" 
                   href="<?php echo e($stores->previousPageUrl()); ?>">
                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('solar-arrow-left-outline'); ?>
...
<?php endif; ?>
        ...
        <?php $__currentLoopData = $stores->getUrlRange(1, $stores->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($page == $stores->currentPage()): ?>
                <li class="page-item">
        ...
        <?php if($stores->hasMorePages()): ?>
            <li class="page-item">
                <a class="page-link bg-accent-50 border border-accent-200 text-black-400 font-medium rounded-lg px-3 py-2 flex items-center justify-center h-[40px] hover:bg-primary-50 hover:border-primary-200 hover:text-primary-400 transition-colors" 
                   href="<?php echo e($stores->nextPageUrl()); ?>">
                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?> <?php /**PATH C:\laragon\www\Liniu_Final\app\Features\SuperLinkiu/Views/stores/components/pagination.blade.php ENDPATH**/ ?>