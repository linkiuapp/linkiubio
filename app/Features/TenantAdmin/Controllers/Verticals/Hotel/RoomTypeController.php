...
class RoomTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant-admin::verticals.hotel.room-types.index', compact('store', 'roomTypes'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant-admin::verticals.hotel.room-types.create', compact('store'));
    }
    ...
    public function show(Request $request)
    {
        ...
        return view('tenant-admin::verticals.hotel.room-types.show', compact('store', 'roomType'));
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('tenant-admin::verticals.hotel.room-types.edit', compact('store', 'roomType'));
    }
