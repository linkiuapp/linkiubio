...
class TableReservationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tenant-admin::verticals.restaurant.reservations.index', compact('store', 'reservations', 'stats', 'filter', 'date'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant-admin::verticals.restaurant.reservations.create', compact('store', 'tables'));
    }
    ...
    public function show($store, Reservation $reservation)
    {
        ...
        return view('tenant-admin::verticals.restaurant.reservations.show', compact('store', 'reservation'));
    }
    ...
    public function settings()
    {
        ...
        return view('tenant-admin::verticals.restaurant.reservations.settings', compact('store', 'settings', 'tables', 'timeSlots'));
    }
