...
class HotelReservationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tenant-admin::hotel.reservations.index', compact(
            'store',
            'reservations',
            'stats',
            'occupancy',
    ...
    public function show(Request $request)
    {
        ...
        return view('tenant-admin::hotel.reservations.show', compact('store', 'hotelReservation'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant-admin::hotel.reservations.create', compact('store', 'roomTypes'));
    }
    ...
    public function settings()
    {
        ...
        return view('tenant-admin::hotel.settings', compact('store', 'settings'));
    }
