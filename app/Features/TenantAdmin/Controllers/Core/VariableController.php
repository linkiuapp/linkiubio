...
class VariableController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $variables = ProductVariable::where('store_id', $store->id)
            ->with(['options'])
            ->withCount([
                'assignments as products_count' => function ($query) {
    ...
    public function edit(Request $request, $storeSlug, ProductVariable $variable)
    {
        ...
        // Cargar opciones y contar productos asociados
        $variable->load(['options']);
        $variable->loadCount(['assignments as products_count' => function ($query) {
            $query->whereHas('product');
        }]);
