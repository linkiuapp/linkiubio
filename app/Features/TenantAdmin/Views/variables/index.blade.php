            ...
            Alpine.data('variableManagement', () => ({
                ...
                async deleteVariable(id, name) {
                    const result = await Swal.fire({
                        ...
                        html: `Se eliminará la variable <strong>"${name}"</strong> de forma permanente`,
                        icon: 'warning',
                        ...
                        preConfirm: async () => {
                            try {
                                const response = await fetch(`/{{ $store->slug }}/admin/variables/${id}`, {
                                    method: 'DELETE',
                                    headers: {
                    ...
                    if (result.isConfirmed) {
                        Swal.fire({
                            icon: 'success',
                            title: '¡Eliminada!',
                            text: 'Variable eliminada exitosamente',
