...
>
    ...
    <form
        action="{{ route('tenant.admin.locations.update', ['store' => $store->slug, 'location' => $location->id]) }}"
        method="POST"
        class="space-y-6"
    >
        @csrf
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    <x-textarea-with-label
                        ...
                        container-class="w-full"
                    >{{ old('description', $location->description) }}</x-textarea-with-label>
                    @error('description')
                        <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-1 space-y-2">
                    ...
                    <div class="flex items-center gap-3">
                        <input type="hidden" name="is_main" value="{{ old('is_main', $location->is_main) ? 1 : 0 }}">
                        <x-switch-basic
                            switch-name="is_main"
                            :checked="old('is_main', $location->is_main)"
                ...
                <div class="md:col-span-1 space-y-2">
                    ...
                    <div class="flex items-center gap-3">
                        <input type="hidden" name="is_active" value="{{ old('is_active', $location->is_active) ? 1 : 0 }}">
                        <x-switch-basic
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    <x-textarea-with-label
                        ...
                        container-class="w-full"
                    >{{ old('whatsapp_message', $location->whatsapp_message) }}</x-textarea-with-label>
                                    ...
                                    <td class="px-4 py-3">
                                        <label class="flex items-center gap-2 text-sm text-gray-600">
                                            <input
                                                ...
                                                data-day="{{ $dayNum }}"
                                                {{ old("day_{$dayNum}_closed", $dbIsClosed) ? 'checked' : '' }}
                                            >
                                            Cerrado
                                        </label>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="flex items-center gap-2"
                                            ...
                                            <input
                                                ...
                                                value="{{ old("day_{$dayNum}_open_1", $openTime1Value) }}"
                                                data-day="{{ $dayNum }}"
                                            >
                                            ...
                                            <input
                                                ...
                                                class="time-input rounded-lg border border-gray-200 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-200"
                                                value="{{ old("day_{$dayNum}_close_1", $closeTime1Value) }}"
                                                data-day="{{ $dayNum }}"
                                            >
                                        </div>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="flex items-center gap-2"
                                            ...
                                            <input
                                                ...
                                                class="time-input rounded-lg border border-gray-200 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-200"
                                                value="{{ old("day_{$dayNum}_open_2", $openTime2Value) }}"
                                                data-day="{{ $dayNum }}"
                                            >
                                            <span class="text-gray-500">a</span>
                                            <input
                                                ...
                                                class="time-input rounded-lg border border-gray-200 px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-200"
                                                value="{{ old("day_{$dayNum}_close_2", $closeTime2Value) }}"
                                                data-day="{{ $dayNum }}"
                                            >
                                        </div>
                ...
                @foreach($platforms as $platform => $label)
                    <div>
                        <x-input-with-label
                            ...
                            value="{{ old('social_' . $platform, optional($socialLinksByPlatform[$platform] ?? null)->url) }}"
                            container-class="w-full"
                            type="url"
                        />
