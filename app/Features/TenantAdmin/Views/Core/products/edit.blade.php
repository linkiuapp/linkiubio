        ...
        <form method="POST" action="{{ route('tenant.admin.products.update', [$store->slug, $product->id]) }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <x-card-base title="Información Básica" shadow="sm">
                <div class="space-y-6">
                    ...
                    <div class="border border-orange-200 rounded-lg p-4 bg-orange-50/50" x-data="{ promocionActiva: {{ old('promocion_activa', $product->promocion_activa) ? 'true' : 'false' }} }">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <x-switch-basic 
                                ...
                                :checked="old('promocion_activa', $product->promocion_activa)"
                                value="1"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" 
                                               ...
                                               value="{{ old('precio_promocional', $product->precio_promocional) }}"
                                               min="0" 
                                               step="0.01"
                                ...
                                <div>
                                    ...
                                    <input type="date" 
                                           ...
                                           value="{{ old('promocion_fecha_inicio', $product->promocion_fecha_inicio?->format('Y-m-d')) }}"
                                ...
                                <div>
                                    ...
                                    <input type="date" 
                                           ...
                                           value="{{ old('promocion_fecha_fin', $product->promocion_fecha_fin?->format('Y-m-d')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                                </div>
                            </div>
                                            ...
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <x-switch-basic 
                                                        ...
                                                        :checked="$isAssigned ? ($assignment->is_required ?? false) : false"
                                                        value="1"
                                                    />
            ...
            {{-- SECTION: Variaciones del Producto (solo para productos variables) --}}
            <x-card-base shadow="sm" id="variations-section" style="display: {{ $product->type === 'variable' ? 'block' : 'none' }};">
                <div x-data="variationsManager()">
                    ...
                    <div class="space-y-4">
                            ...
                            <div class="p-4 bg-gray-50 border border-gray-200 rounded-lg">
                                ...
                                <div class="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                                    <div class="flex items-center justify-between text-sm">
                                        ...
                                        <span class="font-bold text-gray-900">$<span x-text="({{ $product->price ?? 0 }}).toLocaleString('es-CO')"></span></span>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-between text-base mt-2 pt-2 border-t border-blue-300">
                                        ...
                                        <span class="font-bold text-lg text-blue-600">
                                            $<span x-text="({{ $product->price ?? 0 }} + parseFloat(variation.price_modifier || 0)).toLocaleString('es-CO')"></span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        {{-- Empty state cuando no hay variaciones --}}
            ...
            {{-- End SECTION: Variaciones del Producto --}}
        ...
        function variationsManager() {
            return {
                ...
                init() {
                    ...
                    const rawVariables = {!! $variablesJson !!};
                    ...
                    const existingVariations = {!! $variationsJson !!};
