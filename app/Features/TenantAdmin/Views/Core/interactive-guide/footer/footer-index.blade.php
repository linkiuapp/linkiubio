            ...
            <div class="p-6 space-y-6 pb-32">
                <div class="bg-gray-50 rounded-lg border border-gray-200 p-6">
                    ...
                    <div class="space-y-6 bg-white rounded-lg p-6">
                        {{-- Replicación del Footer --}}
                        <div class="bg-white border-t border-gray-200 rounded-lg border p-6">
                            <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                                <p class="text-sm text-gray-600 mb-0 cursor-pointer hover:text-blue-600 transition-colors"
                                   @click="scrollToSection('section-footer-copyright')">
                                    <span class="inline-flex items-center gap-1 px-2 py-0.5 bg-red-100 text-red-700 text-xs font-semibold rounded">Versión Beta 1.0.1</span>
                                    - © {{ date('Y') }} <strong>Linkiu.bio</strong>. Todos los derechos reservados | Desarrollado por <strong>Linkiu Devs ♥️</strong>
                                </p>
                                <div class="flex flex-wrap items-center gap-3 text-xs">
                                    <a href="#" class="text-gray-600 hover:text-blue-600 transition-colors flex items-center gap-1 cursor-pointer"
                                       @click.prevent="scrollToSection('section-footer-about')">
                                        <span>Acerca de <strong>Linkiu</strong></span>
                                        <i data-lucide="arrow-up-right" class="w-3 h-3"></i>
                                    </a>
                                    <a href="#" class="text-gray-600 hover:text-blue-600 transition-colors flex items-center gap-1 cursor-pointer"
                                       @click.prevent="scrollToSection('section-footer-terms')">
                                        <span>Términos y condiciones</span>
                                        <i data-lucide="arrow-up-right" class="w-3 h-3"></i>
                                    </a>
                                    <a href="#" class="text-gray-600 hover:text-blue-600 transition-colors flex items-center gap-1 cursor-pointer"
                                       @click.prevent="scrollToSection('section-footer-privacy')">
                                        <span>Política de privacidad</span>
                                        <i data-lucide="arrow-up-right" class="w-3 h-3"></i>
                                    </a>
                                    <a href="#" class="text-gray-600 hover:text-blue-600 transition-colors flex items-center gap-1 cursor-pointer"
                                       @click.prevent="scrollToSection('section-footer-cookies')">
                                        <span>Política de cookies</span>
                                        <i data-lucide="arrow-up-right" class="w-3 h-3"></i>
                                    </a>
                                    <a href="#" class="text-gray-600 hover:text-blue-600 transition-colors flex items-center gap-1 cursor-pointer"
                                       @click.prevent="scrollToSection('section-footer-refunds')">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="grid md:grid-cols-2 gap-3">
                            <div class="flex items-start gap-3">
                                ...
                                <p class="text-sm text-gray-700"><strong>El footer es un buen lugar</strong> para encontrar información de contacto y soporte</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Revisa los enlaces legales</strong> si tienes dudas sobre términos de uso</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>El estado del sistema</strong> te ayuda a saber si hay problemas conocidos</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Los enlaces rápidos</strong> pueden ser útiles para navegación rápida</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>El footer proporciona información</strong> adicional que puede ser útil en diferentes situaciones</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>El footer está presente</strong> en todas las páginas del panel</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            return {
                ...
                guides: {
                    'section-footer-copyright': {
                        title: 'Copyright y Versión',
                        text: 'Muestra el badge de versión (Versión Beta 1.0.1) en rojo, el copyright con el año actual, el nombre "Linkiu.bio" y el crédito a los desarrolladores "Linkiu Devs ♥️". Esta información está siempre visible en el footer.'
                    },
                    'section-footer-about': {
                        title: 'Enlace "Acerca de Linkiu"',
                        text: 'Enlace que te lleva a la página de información sobre Linkiu. Se abre en una nueva pestaña. Te permite conocer más sobre la plataforma y sus características.'
                    },
                    'section-footer-terms': {
                        title: 'Enlace "Términos y condiciones"',
                        text: 'Enlace que te lleva a los términos y condiciones de uso de la plataforma. Se abre en una nueva pestaña. Te permite revisar las condiciones de uso del servicio.'
                    },
                    'section-footer-privacy': {
                        title: 'Enlace "Política de privacidad"',
                        text: 'Enlace que te lleva a la política de privacidad de Linkiu. Se abre en una nueva pestaña. Te permite conocer cómo se manejan tus datos personales y los datos de tus clientes.'
                    },
                    'section-footer-cookies': {
                        title: 'Enlace "Política de cookies"',
                        text: 'Enlace que te lleva a la política de cookies de Linkiu. Se abre en una nueva pestaña. Te permite conocer qué cookies se utilizan en la plataforma y para qué propósito.'
                    },
                    'section-footer-refunds': {
                        title: 'Enlace "Política de reembolsos"',
                        text: 'Enlace que te lleva a la política de reembolsos de Linkiu. Se abre en una nueva pestaña. Te permite conocer las condiciones y procedimientos para solicitar reembolsos.'
                    }
                },
