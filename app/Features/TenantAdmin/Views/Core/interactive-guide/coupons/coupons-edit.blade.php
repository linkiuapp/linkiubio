                    ...
                    <div class="space-y-6 bg-white rounded-lg p-6">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h1 class="text-lg font-semibold text-gray-900 cursor-pointer hover:text-blue-600 transition-colors" 
                                        @click="scrollToSection('section-header-title')">Editar cupón</h1>
                                    <p class="text-sm text-gray-600 mt-1 cursor-pointer hover:text-blue-600 transition-colors"
                                       @click="scrollToSection('section-header-subtitle')">Descuento de bienvenida — BIENVENIDA20</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <p class="text-sm text-yellow-800">
                                        Este cupón ya se utilizó <strong>5 vez(es)</strong>. Los cambios no afectarán órdenes anteriores.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea rows="3" 
                                              class="w-full px-4 py-3 border border-gray-300 rounded-lg cursor-pointer hover:border-blue-300 transition-colors"
                                              @click="scrollToSection('section-field-description')"
                                              readonly>Aprovecha este descuento especial para nuevos clientes</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-t border-gray-200 pt-6">
                            ...
                            <div class="bg-gray-50 rounded-lg border border-gray-200 p-4">
                                <p class="text-sm text-gray-600 mb-3">Categorías seleccionadas:</p>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    @for($i = 0; $i < 2; $i++)
                                    <div class="bg-white rounded-lg border border-blue-200 p-3 cursor-pointer hover:border-blue-300 transition-colors"
                                         @click="scrollToSection('section-category-item')">
                                        <div class="flex items-center gap-2">
                                            <input type="checkbox" class="w-4 h-4 text-blue-600 rounded cursor-pointer" checked>
                                            <span class="text-sm text-gray-900">Categoría {{ $i + 1 }}</span>
                                        </div>
                                    </div>
                                    @endfor
                                </div>
                                <p class="text-xs text-gray-500 mt-3">Puedes desmarcar las que ya no quieres o marcar nuevas</p>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="bg-gray-50 rounded-lg border border-gray-200 p-4">
                                    <div class="flex items-center justify-between mb-3">
                                        ...
                                        <button class="px-3 py-1.5 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors text-sm cursor-pointer"
                                                @click="scrollToSection('section-button-hide-time')">
                                            Ocultar
                                        </button>
                                    </div>
                                    <div class="space-y-3">
                                        <div>
                                            ...
                                            <div class="flex flex-wrap gap-2">
                                                ...
                                                @endphp
                                                @foreach($days as $day)
                                                <label class="flex items-center gap-2 px-3 py-2 bg-white border border-blue-200 rounded-lg cursor-pointer hover:border-blue-300 transition-colors">
                                                    <input type="checkbox" class="w-4 h-4 text-blue-600 rounded cursor-pointer" 
                                                           {{ in_array($day, ['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes']) ? 'checked' : '' }}
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">El cupón estará disponible inmediatamente después de guardar</p>
                                    </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">El cupón será visible para todos los clientes</p>
                                    </div>
                                    <label class="relative inline-block w-11 h-6 cursor-pointer"
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">El cupón se aplicará automáticamente sin código</p>
                                    </div>
                                    <label class="relative inline-block w-11 h-6 cursor-pointer"
                        ...
                        <div class="border-t border-gray-200 pt-6">
                            ...
                            <p class="text-xs text-gray-500 mt-2 cursor-pointer hover:text-blue-600 transition-colors"
                               @click="scrollToSection('section-preview-note')">La vista previa se actualiza automáticamente mientras modificas los campos</p>
                        </div>
                    ...
                    <div class="flex-1">
                        ...
                        <div class="grid md:grid-cols-2 gap-3">
                            <div class="flex items-start gap-3">
                                ...
                                <p class="text-sm text-gray-700"><strong>Revisa la alerta de advertencia</strong> si el cupón ya se ha usado</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Los cambios no afectan</strong> órdenes anteriores que ya usaron el cupón</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Puedes cambiar el tipo</strong> de aplicación (Global, Categorías, Productos)</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Modifica las restricciones</strong> según necesites actualizar los límites</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Revisa la vista previa</strong> antes de guardar para verificar los cambios</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Si cambias el tipo</strong> de aplicación, deberás seleccionar nuevas categorías/productos</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            return {
                ...
                guides: {
                    ...
                    'section-header-title': {
                        title: 'Título "Editar cupón"',
                        text: 'Muestra que estás editando un cupón existente.'
                    },
                    'section-header-subtitle': {
                        title: 'Subtítulo',
                        text: 'Muestra el nombre y código del cupón que estás editando. Ejemplo: "Descuento de bienvenida — BIENVENIDA20". Te ayuda a identificar qué cupón estás editando.'
                    },
                    'section-button-view': {
                        title: 'Botón "Ver detalles"',
                        text: 'Te lleva a la página de detalles del cupón donde puedes ver toda la información completa y estadísticas.'
                    },
                    'section-warning': {
                        title: 'Alerta de Advertencia',
                        text: 'Si el cupón ya se ha usado, aparece una alerta amarilla de advertencia. Mensaje: "Este cupón ya se utilizó X vez(es). Los cambios no afectarán órdenes anteriores." Esto significa que los pedidos que ya usaron el cupón mantendrán el descuento original. Los cambios solo afectarán a nuevos usos del cupón.'
                    },
                    'section-basic-info': {
                    ...
                    'section-field-name': {
                        ...
                        text: 'Muestra el nombre actual del cupón. Puedes modificarlo. Máximo 120 caracteres.'
                    },
                    'section-field-code': {
                        title: 'Campo "Código del cupón"',
                        text: 'Muestra el código actual del cupón. Puedes modificarlo (debe seguir siendo único). Se convierte automáticamente a mayúsculas.'
                    },
                    ...
                    'section-discount': {
                        ...
                        text: 'Todos los campos son iguales a la creación, pero muestran los valores actuales. Puedes cambiar cualquier configuración.'
                    },
                    'section-field-apply-to': {
                        title: 'Campo "Aplicar a"',
                        text: 'Muestra el tipo de aplicación actual. Puedes cambiarlo (si cambias, deberás seleccionar nuevas categorías/productos).'
                    },
                    'section-field-discount-type': {
                        title: 'Campo "Tipo de descuento"',
                        text: 'Muestra el tipo actual (Porcentaje o Valor Fijo). Puedes cambiarlo.'
                    },
                    'section-field-discount-value': {
                        title: 'Campo "Valor del descuento"',
                        text: 'Muestra el valor actual del descuento. Puedes modificarlo.'
                    },
                    'section-field-max-discount': {
                        title: 'Campo "Descuento máximo"',
                        text: 'Muestra el descuento máximo actual si está configurado. Puedes modificarlo o dejarlo vacío.'
                    },
                    'section-field-min-purchase': {
                        title: 'Campo "Compra mínima"',
                        text: 'Muestra la compra mínima actual si está configurada. Puedes modificarla o dejarla vacía.'
                    },
                    'section-applicability': {
                        title: 'Sección: Aplicabilidad',
                        text: 'Si el cupón es de tipo "Categorías" o "Productos": Muestra las categorías o productos actualmente seleccionados (marcados). Puedes desmarcar los que ya no quieres. Puedes marcar nuevos que quieres agregar. Importante: Si cambias el tipo de "Global" a "Categorías" o "Productos", deberás seleccionar al menos uno.'
                    },
                    'section-category-item': {
                        title: 'Lista de categorías/productos',
                        text: 'Muestra las categorías o productos actualmente seleccionados. Puedes desmarcar los que ya no quieres o marcar nuevos. Debes mantener al menos uno seleccionado.'
                    },
                    'section-restrictions': {
                        title: 'Sección: Restricciones y Límites',
                        text: 'Todos los campos son iguales a la creación, pero muestran los valores actuales. Puedes modificar cualquier restricción.'
                    },
                    'section-field-total-uses': {
                        title: 'Campo "Límite total de usos"',
                        text: 'Muestra el límite actual si está configurado. Puedes modificarlo o dejarlo vacío para usos ilimitados.'
                    },
                    'section-field-uses-per-customer': {
                        title: 'Campo "Usos por cliente"',
                        text: 'Muestra el límite actual por cliente si está configurado. Puedes modificarlo o dejarlo vacío para usos ilimitados.'
                    },
                    'section-field-start-date': {
                        title: 'Campo "Fecha de inicio"',
                        text: 'Muestra la fecha de inicio actual si está configurada. Puedes modificarla o dejarla vacía.'
                    },
                    'section-field-end-date': {
                        title: 'Campo "Fecha de fin"',
                        text: 'Muestra la fecha de fin actual si está configurada. Puedes modificarla o dejarla vacía.'
                    },
                    'section-time-restrictions': {
                        title: 'Sección: Restricciones horarias',
                        text: 'Muestra las restricciones horarias actuales si están configuradas. Puedes modificar días, hora de inicio y hora de fin. Puedes ocultar la sección haciendo clic en "Ocultar".'
                    },
                    'section-button-hide-time': {
                        title: 'Botón "Ocultar"',
                        text: 'Oculta la sección de restricciones horarias. Puedes volver a mostrarla haciendo clic en "Configurar" nuevamente.'
                    },
                    'section-field-allowed-days': {
                        title: 'Días permitidos',
                        text: 'Muestra los días actualmente seleccionados. Puedes modificar marcando o desmarcando días según necesites.'
                    },
                    ...
                    'section-config': {
                        ...
                        text: 'Todos los interruptores muestran el estado actual. Puedes cambiar cualquier configuración.'
                    },
                    'section-toggle-active': {
                        title: 'Interruptor "Activar al guardar"',
                        text: 'Muestra el estado activo/inactivo actual. Puedes cambiar el estado activo/inactivo del cupón.'
                    },
                    'section-toggle-public': {
                        title: 'Interruptor "Cupón público"',
                        text: 'Muestra si el cupón es público o privado actualmente. Puedes hacerlo público o privado.'
                    },
                    'section-toggle-auto': {
                        title: 'Interruptor "Aplicación automática"',
                        text: 'Muestra si el cupón se aplica automáticamente actualmente. Puedes activar o desactivar la aplicación automática.'
                    },
                    'section-preview': {
                        title: 'Sección: Vista Previa',
                        text: 'Muestra cómo se verá el cupón con los cambios actuales. Se actualiza automáticamente mientras modificas los campos.'
                    },
                    'section-preview-card': {
                        title: 'Tarjeta de vista previa',
                        text: 'Muestra cómo se verá el cupón con los cambios actuales. Incluye nombre, código, alcance, valor del descuento y descripción estimada.'
                    },
                    'section-preview-note': {
                        title: 'Nota de vista previa',
                        text: 'Texto que dice: "La vista previa se actualiza automáticamente mientras modificas los campos". Te indica que puedes ver los cambios en tiempo real.'
                    },
                    'section-button-cancel': {
                        title: 'Botón "Cancelar"',
                        text: 'Cancela la edición y regresa al listado de cupones. No guarda ningún cambio.'
                    },
                    'section-button-save': {
