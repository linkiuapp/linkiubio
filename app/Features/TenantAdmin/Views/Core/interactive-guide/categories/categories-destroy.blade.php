            ...
            <div class="p-6 space-y-6 pb-32">
                ...
                <div class="bg-blue-50 rounded-lg border border-blue-200 p-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h2 class="text-base font-semibold text-gray-900 mb-2">Restricción Importante: No se Pueden Eliminar Categorías con Productos</h2>
                            <p class="text-sm font-regular text-gray-700 leading-relaxed mb-3">
                                <strong>Solo puedes eliminar categorías que NO tengan productos asociados.</strong>
                            </p>
                            <p class="text-sm font-regular text-gray-700 leading-relaxed">
                                Si una categoría tiene productos, <strong>NO podrás eliminarla</strong>. Primero debes quitar todos los productos de esa categoría o moverlos a otra categoría.
                            </p>
                        </div>
                    </div>
                </div>

                {{-- ¿Qué es Eliminar una Categoría? --}}
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                    <h2 class="text-base font-semibold text-gray-900 mb-4">¿Qué es Eliminar una Categoría?</h2>
                    <p class="text-sm text-gray-700 leading-relaxed mb-4">
                        Eliminar una categoría significa borrarla completamente del sistema. Una vez eliminada, no podrás recuperarla ni verla nuevamente.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            <h3 class="text-sm font-medium text-gray-800 mb-2">Desde la Vista Detallada (Show)</h3>
                            <p class="text-sm text-gray-700 leading-relaxed">
                                En la vista detallada de una categoría, hay un botón "Eliminar" en el encabezado. Al hacer clic, aparece un cuadro de confirmación.
                            </p>
                        </div>
                        <div>
                            <h3 class="text-sm font-medium text-gray-800 mb-2">Desde la Vista de Edición (Edit)</h3>
                            <p class="text-sm text-gray-700 leading-relaxed">
                                En la pantalla de edición, hay un botón "Eliminar" en la parte inferior izquierda. Solo aparece si la categoría no tiene productos. Al hacer clic, aparece un cuadro de confirmación.
                            </p>
                        </div>
                        <div>
                            <h3 class="text-sm font-medium text-gray-800 mb-2">Desde la Lista de Categorías (Index)</h3>
                            <p class="text-sm text-gray-700 leading-relaxed">
                                En la tabla de categorías, cada fila tiene un icono de papelera en la columna de acciones. Si la categoría tiene productos, el icono aparece gris y deshabilitado. Si no tiene productos, puedes hacer clic para eliminar.
                            </p>
                        </div>
                        <div>
                            <h3 class="text-sm font-medium text-gray-800 mb-2">Eliminación Múltiple</h3>
                            <p class="text-sm text-gray-700 leading-relaxed">
                                En la lista de categorías, puedes seleccionar varias categorías usando las casillas de verificación y luego hacer clic en "Eliminar [X] categorías". Solo se eliminarán las categorías que no tengan productos.
                            </p>
                        </div>
                    </div>
                </div>

                {{-- ¿Qué Pasa con las Subcategorías? --}}
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                    <h2 class="text-base font-semibold text-gray-900 mb-4">¿Qué Pasa con las Subcategorías?</h2>
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                        <h3 class="text-sm font-medium text-gray-800 mb-2">Si Eliminas una Categoría Principal</h3>
                        <p class="text-sm text-gray-700 leading-relaxed mb-2">
                            Si eliminas una categoría principal que tiene subcategorías:
                        </p>
                        <ul class="list-disc list-inside text-sm text-gray-700 space-y-1 ml-4">
                            <li>Las subcategorías NO se eliminan automáticamente</li>
                            <li>Las subcategorías se convierten en categorías principales</li>
                            <li>Esto puede afectar la organización de tus productos</li>
                        </ul>
                    </div>
                    <p class="text-sm text-gray-700 leading-relaxed">
                        <strong>Recomendación:</strong> Antes de eliminar una categoría principal con subcategorías, considera eliminar primero las subcategorías (si no tienen productos) o mover las subcategorías a otra categoría principal.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                    ...
                    <div class="space-y-3">
                        <div>
                            <h3 class="text-sm font-medium text-gray-800 mb-2">Cuando eliminas una categoría, se borra:</h3>
                            <ul class="list-disc list-inside text-sm text-gray-700 space-y-1 ml-4">
                                <li>El registro de la categoría</li>
                                <li>La relación con su categoría padre (si era subcategoría)</li>
                                <li>Toda la información de la categoría (nombre, descripción, slug, etc.)</li>
                            </ul>
                        </div>
                        <div>
                            <h3 class="text-sm font-medium text-gray-800 mb-2">NO se elimina:</h3>
                            <ul class="list-disc list-inside text-sm text-gray-700 space-y-1 ml-4">
                                <li>Los productos que estaban en esa categoría (pero se les quita la categoría)</li>
                                <li>Las subcategorías (se convierten en categorías principales)</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        <div class="border-l-4 border-blue-500 pl-4">
                            <h3 class="text-sm font-medium text-gray-800 mb-2">Desactivar la Categoría</h3>
                            <ul class="list-disc list-inside text-sm text-gray-700 space-y-1 ml-4">
                                <li>Cambia el estado a "Inactiva"</li>
                                <li>La categoría no se muestra en tu tienda</li>
                                <li>Mantiene el registro y los productos asociados</li>
                                <li>Puedes reactivarla cuando quieras</li>
                                <li><strong>Más seguro:</strong> No pierdes información</li>
                            </ul>
                        </div>
                        <div class="border-l-4 border-green-500 pl-4">
                            <h3 class="text-sm font-medium text-gray-800 mb-2">Reorganizar Productos</h3>
                            <ul class="list-disc list-inside text-sm text-gray-700 space-y-1 ml-4">
                                <li>Mueve los productos a otra categoría</li>
                                <li>Luego elimina la categoría vacía</li>
                                <li>Mantienes todos tus productos organizados</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-red-50 rounded-lg border border-red-200 p-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-regular text-gray-700 leading-relaxed">
                                <strong>Eliminar una categoría es una acción permanente e irreversible.</strong> Asegúrate de estar completamente seguro antes de eliminar cualquier categoría. En la mayoría de los casos, es mejor desactivar la categoría en lugar de eliminarla.
                            </p>
                        </div>
                    </div>
                </div>
