                        ...
                        <div class="border border-gray-200 rounded-lg p-6">
                            ...
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <div class="flex-1">
                                    <h3 class="text-lg font-semibold text-gray-900 cursor-pointer hover:text-blue-600 transition-colors"
                                        @click="scrollToSection('section-card-title')">Recogida en Tienda</h3>
                                    <p class="text-sm text-gray-600 cursor-pointer hover:text-blue-600 transition-colors"
                                       @click="scrollToSection('section-card-description')">Los clientes pueden recoger sus pedidos directamente</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between mb-4 pb-4 border-b border-gray-200">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">Activa o desactiva la opción de recogida en tienda</p>
                                </div>
                                <div class="flex items-center gap-3">
                                    <span class="text-sm text-gray-600" id="toggle-status">Habilitado</span>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-800 mb-2 cursor-pointer hover:text-blue-600 transition-colors"
                                           @click="scrollToSection('section-prep-time')">
                                        Tiempo de preparación
                                    </label>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">Tiempo necesario para preparar el pedido antes de que el cliente pueda recogerlo</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea rows="4" 
                                              ...
                                              @click="scrollToSection('section-instructions')"
                                              placeholder="Ejemplo: Dirección de tu tienda, horarios de atención, qué documentos debe traer, dónde debe dirigirse dentro de la tienda..."
                                              readonly>Puedes recoger tu pedido en nuestra tienda ubicada en Calle Principal #123. Horario de atención: Lunes a Viernes de 9:00 AM a 6:00 PM. Por favor trae tu identificación y el número de pedido.</textarea>
                                    <div class="flex items-center justify-between mt-1">
                                        <p class="text-xs text-gray-500">Máximo 500 caracteres</p>
                                        <span class="text-xs text-gray-400">145/500</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex-1">
                        ...
                        <div class="grid md:grid-cols-2 gap-3">
                            <div class="flex items-start gap-3">
                                ...
                                <p class="text-sm text-gray-700"><strong>Sé claro y específico</strong> en las instrucciones para que el cliente sepa exactamente cómo recoger su pedido</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Incluye la dirección completa</strong> de tu tienda en las instrucciones</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Menciona los horarios</strong> en los que pueden recoger los pedidos</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Si hay requisitos especiales</strong> (como traer identificación), menciónalos en las instrucciones</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Esta opción es gratuita</strong> para el cliente (no tiene costo de envío)</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Puedes desactivar esta opción</strong> en cualquier momento sin perder la configuración</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            return {
                ...
                guides: {
                    'section-card-header': {
                        ...
                        text: 'Muestra un ícono de tienda en un fondo azul. Identifica visualmente la sección de recogida en tienda.'
                    },
                    'section-card-title': {
                        title: 'Título "Recogida en Tienda"',
                        text: 'Muestra el nombre de la opción de envío. Es el título principal de esta sección.'
                    },
                    'section-card-description': {
                        title: 'Descripción',
                        text: 'Texto que dice "Los clientes pueden recoger sus pedidos directamente". Explica brevemente qué es esta opción.'
                    },
                    'section-toggle': {
                        title: 'Interruptor Habilitado/Deshabilitado',
                        text: 'Este interruptor activa o desactiva la opción de recogida en tienda. Cuando está activado, aparece el texto "Habilitado" en gris. Cuando está desactivado, aparece el texto "Deshabilitado" en gris. Solo cuando está activado, se muestran los campos de configuración debajo.'
                    },
                    'section-prep-time': {
                        title: 'Campo "Tiempo de preparación"',
                        text: 'Este campo te permite elegir cuánto tiempo necesitas para preparar el pedido antes de que el cliente pueda recogerlo. Opciones disponibles: 30 minutos, 1 hora, 2 horas, 4 horas. Selecciona el tiempo que mejor se ajuste a tu negocio.'
                    },
                    'section-instructions': {
                        title: 'Campo "Instrucciones para el cliente"',
                        text: 'Aquí puedes escribir información importante que el cliente debe saber sobre cómo recoger su pedido. Ejemplos: Dirección de tu tienda, horarios de atención, qué documentos debe traer, dónde debe dirigirse dentro de la tienda. Este texto aparecerá cuando el cliente seleccione esta opción de envío. Máximo 500 caracteres (se muestra un contador debajo del campo).'
                    }
                },
