                    ...
                    <div class="space-y-6 bg-white rounded-lg p-6">
                        ...
                        <div class="border-2 border-blue-500 rounded-lg p-6 shadow-md">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-900 cursor-pointer hover:text-blue-600 transition-colors"
                                            @click="scrollToSection('section-card-title')">Contra Entrega</h3>
                                        <p class="text-sm text-gray-600 cursor-pointer hover:text-blue-600 transition-colors"
                                           @click="scrollToSection('section-card-description')">Pago al recibir el producto</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-wrap gap-2 mb-4">
                                <span class="px-2.5 py-1 bg-gray-100 text-gray-500 text-xs rounded-full cursor-pointer"
                    ...
                    <div class="flex-1">
                        ...
                        <div class="grid md:grid-cols-2 gap-3">
                            <div class="flex items-start gap-3">
                                ...
                                <p class="text-sm text-gray-700"><strong>Activa este método si haces entregas</strong> a domicilio y quieres que el cliente pague al recibir</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Asegúrate de tener envíos configurados</strong> antes de activar este método</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Establece este método como principal</strong> si la mayoría de tus clientes prefieren pagar contra entrega</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Considera que necesitarás tener efectivo</strong> para dar cambio si el cliente paga con billetes grandes</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Solo disponible para entregas</strong>: Este método NO funciona para pedidos que se recogen en tienda</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Requiere método de envío activo</strong>: Debes tener al menos un método de envío configurado y activo</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            return {
                ...
                guides: {
                    'section-card-header': {
                        ...
                        text: 'Muestra un ícono de camión en un fondo azul cuando está activado, o gris cuando está desactivado. Identifica visualmente el método de pago.'
                    },
                    'section-card-title': {
                        title: 'Título "Contra Entrega"',
                        text: 'Muestra el nombre del método de pago. Es el título principal de esta tarjeta.'
                    },
                    'section-card-description': {
                        title: 'Descripción',
                        text: 'Texto que dice "Pago al recibir el producto". Explica brevemente qué es este método de pago.'
                    },
                    'section-toggle': {
                        title: 'Interruptor Habilitado/Deshabilitado',
                        text: 'Este interruptor activa o desactiva el método de pago contra entrega. Cuando está activado, el borde de la tarjeta se vuelve azul y aparece una sombra. Cuando está desactivado, el borde es gris y no hay sombra. Solo cuando está activado, se muestran las opciones de configuración y los botones.'
                    },
                    'section-badge-recogida': {
                        title: 'Badge "Recogida"',
                        text: 'Siempre aparece desactivado (fondo gris con texto gris). Este método NO está disponible para pedidos que se recogen en tienda. Solo funciona para entregas a domicilio.'
                    },
                    ...
                    'section-button-configure': {
                        ...
                        text: 'Te permite abrir un modal para configurar las opciones del método. Opciones disponibles: Disponible para entrega (activar/desactivar). Nota: "Disponible para recogida" aparece deshabilitado porque este método solo funciona para entregas.'
                    },
