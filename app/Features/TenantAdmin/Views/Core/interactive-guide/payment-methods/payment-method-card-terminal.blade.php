                    ...
                    <div class="space-y-6 bg-white rounded-lg p-6">
                        ...
                        <div class="border-2 border-blue-500 rounded-lg p-6 shadow-md">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-900 cursor-pointer hover:text-blue-600 transition-colors"
                                            @click="scrollToSection('section-card-title')">Datáfono</h3>
                                        <p class="text-sm text-gray-600 cursor-pointer hover:text-blue-600 transition-colors"
                                           @click="scrollToSection('section-card-description')">Tarjeta de crédito o débito</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3">
                            ...
                            <div class="flex flex-wrap gap-2 mb-4">
                                ...
                                <span class="px-2.5 py-1 bg-purple-100 text-purple-700 text-xs rounded-full cursor-pointer hover:bg-purple-200 transition-colors"
                                      @click="scrollToSection('section-badge-cards')">Visa, Mastercard</span>
                            </div>
                            ...
                            <div class="flex gap-2">
                                ...
                                <button class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer"
                                        @click="scrollToSection('section-button-make-primary')">
                                    Hacer principal
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="flex-1">
                        ...
                        <div class="grid md:grid-cols-2 gap-3">
                            <div class="flex items-start gap-3">
                                ...
                                <p class="text-sm text-gray-700"><strong>Activa solo los tipos de tarjetas</strong> que realmente aceptas según tu convenio</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Si tienes datáfono móvil</strong>, puedes activar tanto "Recogida" como "Entrega"</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Establece este método como principal</strong> si la mayoría de tus clientes pagan con tarjeta</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Verifica que tu datáfono esté conectado</strong> y funcionando antes de activar el método</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Debes tener un datáfono físico</strong> para procesar los pagos con tarjeta</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Puedes aceptar múltiples tipos de tarjetas</strong> según tu convenio con el procesador de pagos</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            return {
                ...
                guides: {
                    'section-card-header': {
                        ...
                        text: 'Muestra un ícono de smartphone con NFC en un fondo azul cuando está activado, o gris cuando está desactivado. Identifica visualmente el método de pago.'
                    },
                    'section-card-title': {
                        title: 'Título "Datáfono"',
                        text: 'Muestra el nombre del método de pago. Es el título principal de esta tarjeta.'
                    },
                    'section-card-description': {
                        title: 'Descripción',
                        text: 'Texto que dice "Tarjeta de crédito o débito". Explica brevemente qué es este método de pago.'
                    },
                    'section-toggle': {
                        title: 'Interruptor Habilitado/Deshabilitado',
                        text: 'Este interruptor activa o desactiva el método de pago con datáfono. Cuando está activado, el borde de la tarjeta se vuelve azul y aparece una sombra. Cuando está desactivado, el borde es gris y no hay sombra. Solo cuando está activado, se muestran las opciones de configuración y los botones.'
                    },
                    ...
                    'section-badge-cards': {
                        title: 'Badge "Visa, Mastercard"',
                        text: 'Siempre aparece cuando el método está activado. Fondo morado con texto morado. Indica los tipos de tarjetas que aceptas (puedes configurar cuáles aceptar).'
                    },
                    'section-button-configure': {
                        title: 'Botón "Configurar"',
                        text: 'Te permite abrir un modal para configurar las opciones del método. Opciones disponibles: Disponible para recogida (activar/desactivar), Disponible para entrega (activar/desactivar), Tarjetas aceptadas: Visa (activar/desactivar), Mastercard (activar/desactivar), American Express (activar/desactivar).'
                    },
                    'section-button-make-primary': {
                        title: 'Botón "Hacer principal"',
                        text: 'Establece este método como el predeterminado. El método principal es el que aparece seleccionado por defecto cuando el cliente hace un pedido. Solo un método puede ser principal a la vez. Solo visible si NO es el método principal.'
                    }
                },
