                        ...
                        <div class="flex items-center justify-between pb-4 border-b border-gray-200">
                            <div>
                                <h1 class="text-lg font-semibold text-gray-900 cursor-pointer hover:text-blue-600 transition-colors" 
                                    @click="scrollToSection('section-header')">Variables</h1>
                                <p class="text-sm text-gray-600 mt-1 cursor-pointer hover:text-blue-600 transition-colors"
                                   @click="scrollToSection('section-header')">
                                    Usando 3 de 10 variables disponibles en tu plan Básico
                                </p>
                            </div>
                                    ...
                                    <thead class="bg-gray-50">
                                        <tr>
                                            ...
                                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase cursor-pointer hover:text-blue-600 hover:bg-blue-50 transition-colors group relative"
                                                @click="scrollToSection('section-table-variable')">
                                                <div class="flex items-center gap-2">
                                                    <span>Variable</span>
                                            ...
                                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase cursor-pointer hover:text-blue-600 hover:bg-blue-50 transition-colors group relative"
                                                @click="scrollToSection('section-table-options')">
                                                <div class="flex items-center gap-2">
                                                    <span>Opciones</span>
                                                    <i data-lucide="info" class="w-3 h-3 text-blue-500 group-hover:text-blue-600 transition-colors"></i>
                                                </div>
                    ...
                    <div class="flex-1">
                        ...
                        <div class="grid md:grid-cols-2 gap-3">
                            <div class="flex items-start gap-3">
                                ...
                                <p class="text-sm text-gray-700"><strong>Usa los filtros</strong> para encontrar variables específicas rápidamente</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Activa/desactiva variables</strong> usando el interruptor sin necesidad de editarlas</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Revisa cuántos productos tiene</strong> cada variable antes de intentar eliminarla</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Las variables inactivas</strong> no se pueden usar en productos nuevos pero siguen existiendo</p>
                            </div>
                            <div class="flex items-start gap-3">
                                <i data-lucide="check-circle" class="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0"></i>
                                <p class="text-sm text-gray-700"><strong>Los tipos de variable</strong> determinan cómo los clientes interactuarán con tus productos</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            return {
                ...
                guides: {
                    'section-header': {
                        ...
                        text: '<strong>Título "Variables":</strong> Muestra el nombre de la sección donde estás. Te indica que estás en la pantalla para administrar todas las variables de tus productos.<br><br><strong>Información del Plan:</strong> Debajo del título aparece un texto que dice cuántas variables estás usando y cuántas tienes disponibles según tu plan. Por ejemplo: "Usando 3 de 10 variables disponibles en tu plan Básico".'
                    },
                    'section-buttons-delete': {
                        title: 'Botón "Eliminar [X] variables"',
                        text: 'Este botón aparece cuando seleccionas una o más variables usando las casillas de verificación. Te permite eliminar varias variables a la vez. Solo puedes eliminar variables que no tengan productos asociados.'
                    },
                    'section-buttons-new': {
                        title: 'Botón "Nueva Variable"',
                        text: 'Este botón te lleva a la pantalla para crear una variable nueva. Si ya alcanzaste el límite de variables de tu plan, el botón aparece deshabilitado y dice "Límite Alcanzado".'
                    },
                    'section-filters-status': {
                        title: 'Select "Filtrar por estado"',
                        text: 'Te permite filtrar las variables por su estado: <strong>Todas:</strong> Muestra todas las variables (activas e inactivas), <strong>Activas:</strong> Solo muestra las variables que están activas y disponibles para usar en productos, <strong>Inactivas:</strong> Solo muestra las variables que están desactivadas y no se pueden usar.'
                    },
                    'section-filters-type': {
                        title: 'Select "Filtrar por tipo"',
                        text: 'Te permite filtrar las variables por su tipo: <strong>Todos los tipos:</strong> Muestra todas las variables sin importar su tipo, <strong>Selección única:</strong> Solo muestra variables de tipo "radio" (el cliente elige una opción), <strong>Selección múltiple:</strong> Solo muestra variables de tipo "checkbox" (el cliente puede elegir varias opciones), <strong>Texto libre:</strong> Solo muestra variables de tipo "text" (el cliente escribe texto), <strong>Numérico:</strong> Solo muestra variables de tipo "numeric" (el cliente ingresa un número).'
                    },
                    'section-table-variable': {
                        title: 'Columna "Variable"',
                        text: 'Muestra la información principal de cada variable: <strong>Ícono:</strong> Un icono que representa el tipo de variable o su nombre (por ejemplo, paleta para "Color", regla para "Talla"), <strong>Nombre:</strong> El nombre de la variable (en negrita), <strong>Información adicional:</strong> Debajo del nombre aparece información según el tipo: Si tiene opciones: Muestra cuántas opciones tiene (ej: "5 opciones"), Si es numérica: Muestra el rango de valores (ej: "Rango: 0 - 100"), Si es texto: Muestra "Texto libre".'
                    },
                    'section-table-type': {
                        title: 'Columna "Tipo"',
                        text: 'Muestra el tipo de variable con un badge azul: <strong>Selección única:</strong> Variable tipo "radio" (el cliente elige una opción de una lista), <strong>Selección múltiple:</strong> Variable tipo "checkbox" (el cliente puede elegir varias opciones), <strong>Texto libre:</strong> Variable tipo "text" (el cliente escribe lo que quiera), <strong>Numérico:</strong> Variable tipo "numeric" (el cliente ingresa un número).'
                    },
                    'section-table-status': {
                        title: 'Columna "Estado"',
                        text: 'Muestra si la variable está activa o inactiva: <strong>Badge verde "Activa":</strong> La variable está activa y se puede usar en productos, <strong>Badge rojo "Inactiva":</strong> La variable está inactiva y no se puede usar en productos.'
                    },
                    'section-table-toggle': {
                        title: 'Columna "Activar/Desactivar"',
                        text: 'Tiene un interruptor (switch) que te permite activar o desactivar la variable rápidamente sin tener que editarla. Solo haz clic en el interruptor y el estado cambia automáticamente.'
                    },
                    'section-table-options': {
                        title: 'Columna "Opciones"',
                        text: 'Muestra cuántas opciones tiene la variable. Solo aparece un número si la variable es de tipo "radio" o "checkbox" (variables de selección). Si es de otro tipo, aparece un guión (-).'
                    },
                    'section-table-products': {
                        title: 'Columna "Productos"',
                        text: 'Muestra cuántos productos tienen asociada esta variable. Aparece como un badge azul con el número.'
                    },
                    'section-table-actions': {
                        title: 'Columna "Acciones"',
                        text: 'Contiene tres iconos para realizar acciones sobre cada variable:<br><br><strong>Icono de Ojo (Ver detalles):</strong> Este icono te lleva a la vista detallada de la variable. Allí puedes ver toda la información completa de la variable, sus opciones y en qué productos se usa.<br><strong>Icono de Lápiz (Editar):</strong> Este icono te lleva a la pantalla de edición donde puedes modificar los datos de la variable.<br><strong>Icono de Papelera (Eliminar):</strong> Este icono te permite eliminar la variable. Solo aparece habilitado si la variable no tiene productos asociados. Si tiene productos, el icono aparece gris y deshabilitado. Al hacer clic, aparece un cuadro de confirmación.'
                    },
                    'section-pagination': {
                        title: 'Paginación',
                        text: 'Te permite navegar entre las diferentes páginas de variables cuando tienes muchas variables. <strong>Botón "Anterior" (flecha izquierda):</strong> Te lleva a la página anterior de variables. Está deshabilitado si estás en la primera página.<br><br><strong>Números de página:</strong> Cada número representa una página. El número resaltado en azul indica la página actual. Haz clic en cualquier número para ir a esa página.<br><br><strong>Botón "Siguiente" (flecha derecha):</strong> Te lleva a la página siguiente de variables. Está deshabilitado si estás en la última página.'
                    }
                },
