            ...
            Alpine.data('sliderManagement', () => ({
                ...
                async deleteSlider(id, name) {
                    const result = await Swal.fire({
                        ...
                        html: `Se eliminará el slider <strong>"${name}"</strong> de forma permanente`,
                        icon: 'warning',
                        ...
                        preConfirm: async () => {
                            try {
                                const response = await fetch(`/{{ $store->slug }}/admin/sliders/${id}`, {
                                    method: 'DELETE',
                                    headers: {
                    ...
                    if (result.isConfirmed) {
                        Swal.fire({
                            icon: 'success',
                            title: '¡Eliminado!',
                            text: 'Slider eliminado exitosamente',
