{{--
File Upload Basic - Subida de archivos básica
Uso: Permite subir múltiples archivos con preview y barra de progreso
Cuándo usar: Cuando necesites subir archivos con vista previa y progreso
Cuándo NO usar: Cuando solo necesites subir una imagen (usa FileUploadSingleImage)
Ejemplo: <x-file-upload-basic uploadUrl="/upload" maxFileSize="2" />
