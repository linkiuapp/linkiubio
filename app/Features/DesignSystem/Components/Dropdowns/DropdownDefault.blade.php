{{--
Dropdown Default - Menú desplegable básico
Uso: Menú desplegable simple con lista de opciones
Cuándo usar: Cuando necesites mostrar opciones adicionales al hacer clic en un botón
Cuándo NO usar: Cuando solo necesites un botón simple sin opciones
Ejemplo: <x-dropdown-default :items="[['label' => 'Newsletter', 'url' => '#'], ['label' => 'Purchases', 'url' => '#']]" />
--}}
...
@php
    $uniqueId = $triggerId ?? 'dropdown-' . uniqid();
@endphp
