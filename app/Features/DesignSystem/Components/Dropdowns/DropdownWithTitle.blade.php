{{--
Dropdown With Title - Menú desplegable con títulos de sección
Uso: Menú desplegable que agrupa opciones bajo títulos
Cuándo usar: Cuando necesites organizar las opciones en categorías o secciones
Cuándo NO usar: Cuando las opciones no necesiten agrupación
Ejemplo: <x-dropdown-with-title :sections="[['title' => 'Configuración', 'items' => [['label' => 'Newsletter', 'url' => '#', 'icon' => 'bell']]], ['title' => 'Contactos', 'items' => [['label' => 'Soporte', 'url' => '#', 'icon' => 'message-circle']]]]" />
--}}

@props([
    'sections' => [], // Array de secciones: [['title' => '...', 'items' => [['label' => '...', 'url' => '...', 'icon' => '...']]]]
    'triggerText' => 'Acciones',
    'triggerId' => null,
])

@php
    $uniqueId = $triggerId ?? 'dropdown-title-' . uniqid();
@endphp
