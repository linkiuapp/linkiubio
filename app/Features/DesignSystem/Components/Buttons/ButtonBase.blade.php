{{--
Botón Base - Componente principal para todos los tipos de botones basado en Preline UI
Uso: Botón versátil que maneja todos los estilos, tamaños y colores de Preline UI
Cuándo usar: Para acciones principales, navegación, formularios, cualquier interacción
Cuándo NO usar: Para texto puro sin acción, enlaces que no requieren apariencia de botón
Ejemplo: <x-button-base type="solid" color="info" size="md" text="Guardar" />
--}}
