{{--
Botón con Icono - Botón que incluye un icono de Lucide junto al texto
Uso: Botones que requieren iconografía para mejorar la UX y comunicar la acción
Cuándo usar: Acciones con significado visual claro, navegación, formularios importantes
Cuándo NO usar: Botones simples de texto, cuando el icono no aporta claridad
Ejemplo: <x-button-icon type="solid" color="info" icon="shopping-cart" text="Agregar al carrito" />
--}}
...
@php
    // Size classes (same as ButtonBase)
    $sizeClasses = [
    ...
    // Type and color combinations (same as ButtonBase)
    $typeColorClasses = [
        'solid' => [
    ...
    // Final classes
    $classes = trim("{$baseClasses} {$sizeClass} {$typeColorClass} {$borderClass} {$blockClass} {$fontClass}");
@endphp
