{{--
Pagination End - Paginación alineada a la derecha
Uso: Paginación con botones alineados a la derecha
Cuándo usar: Para paginación alineada al final del contenedor
Cuándo NO usar: Cuando prefieras centrado o izquierda
Ejemplo: <x-pagination-end :current="1" :total="10" :url="route('products.index')" />
--}}
...
<nav class="flex justify-end items-center gap-x-1" aria-label="Pagination" {{ $attributes }}>
    @if($showPrevNext)
        <button 
            type="button" 
