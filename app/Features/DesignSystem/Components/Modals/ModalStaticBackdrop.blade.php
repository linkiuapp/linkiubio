{{--
Modal Static Backdrop - Modal con backdrop estático
Uso: Modal que no se cierra al hacer clic fuera de él
Cuándo usar: Cuando necesites que el usuario confirme explícitamente una acción antes de cerrar
Cuándo NO usar: Cuando quieras que el modal se cierre fácilmente haciendo clic fuera
Ejemplo: <x-modal-static-backdrop modalId="my-modal" title="Título" content="Contenido" />
--}}
...
@php
    $uniqueId = $modalId ?? 'modal-static-' . uniqid();
@endphp
...
<div x-data="{ open: false }" x-on:keydown.escape.window="open = false">
    ...
    <div 
        ...
        {{-- No cierra al hacer clic en el backdrop --}}
        style="display: none;"
    ></div>
