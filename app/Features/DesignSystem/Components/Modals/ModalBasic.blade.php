{{--
Modal Basic - Modal básico
Uso: Diálogo modal básico con overlay desenfocado
Cuándo usar: Cuando necesites mostrar contenido en un diálogo modal
Cuándo NO usar: Cuando el contenido no requiera atención enfocada
Ejemplo: <x-modal-basic modalId="my-modal" title="Título" content="Contenido del modal" />
--}}
