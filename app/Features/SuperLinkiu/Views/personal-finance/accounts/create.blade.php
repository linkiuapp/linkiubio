...
<div class="max-w-2xl mx-auto mt-6">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h1 class="text-lg font-semibold text-gray-800 mb-6">Nueva Cuenta Bancaria</h1>

        <form action="{{ route('superlinkiu.personal-finance.accounts.store') }}" method="POST">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select name="type" required
                        ...
                        <option value="checking" {{ old('type') === 'checking' ? 'selected' : '' }}>Cuenta Corriente</option>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="current_balance" value="{{ old('current_balance', 0) }}" step="0.01" min="0"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
