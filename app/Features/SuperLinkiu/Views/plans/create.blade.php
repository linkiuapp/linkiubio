...
<div class="max-w-6xl mx-auto space-y-6 mt-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-lg font-semibold text-gray-800">Crear Nuevo Plan</h1>
                <p class="text-sm text-gray-600 mt-1">Configura un nuevo plan de suscripción</p>
            </div>
        </div>
    </div>
    ...
    {{-- Form --}}
    <form method="POST" action="{{ route('superlinkiu.plans.store') }}" enctype="multipart/form-data" 
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div>
                            ...
                            <input type="number" name="max_products" value="{{ old('max_products', 500) }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-800 mb-2">
                                Categorías <span class="text-red-500">*</span>
                            </label>
                            <input type="number" name="max_categories" value="{{ old('max_categories', 10) }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-800 mb-2">
                                Variables <span class="text-red-500">*</span>
                            </label>
                            <input type="number" name="max_variables" value="{{ old('max_variables', 15) }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        ...
                        <div>
                            ...
                            <input type="number" name="max_product_images" value="{{ old('max_product_images', 5) }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="max_slider" value="{{ old('max_slider', 5) }}" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-800 mb-2">
                                Cupones Activos <span class="text-red-500">*</span>
                            </label>
                            <input type="number" name="max_active_coupons" value="{{ old('max_active_coupons', 10) }}" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="max_sedes" value="{{ old('max_sedes', 3) }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-800 mb-2">
                                Zonas de Reparto <span class="text-red-500">*</span>
                            </label>
                            <input type="number" name="max_delivery_zones" value="{{ old('max_delivery_zones', 10) }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="max_payment_methods" value="{{ old('max_payment_methods', 4) }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-800 mb-2">
                                Cuentas Bancarias <span class="text-red-500">*</span>
                            </label>
                            <input type="number" name="max_bank_accounts" value="{{ old('max_bank_accounts', 5) }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div>
                            ...
                            <input type="number" name="max_admins" value="{{ old('max_admins', 2) }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-800 mb-2">
                                Tickets/Mes <span class="text-red-500">*</span>
                            </label>
                            <input type="number" name="max_tickets_per_month" value="{{ old('max_tickets_per_month', 50) }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-800 mb-2">
                            ...
                            <div class="flex items-center gap-2">
                                <input type="number" name="order_history_months" value="{{ old('order_history_months', 12) }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <input type="number" name="analytics_retention_days" value="{{ old('analytics_retention_days', 365) }}" min="30" step="30" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    ...
                    <div x-show="open" x-collapse class="p-4 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="max_tables" value="{{ old('max_tables', 30) }}" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ...
                            <div>
                                ...
                                <input type="number" name="max_daily_reservations" value="{{ old('max_daily_reservations', 150) }}" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <p class="mt-1 text-xs text-gray-600">0 = ilimitado</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div x-show="open" x-collapse class="p-4 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div>
                                ...
                                <input type="number" name="max_rooms" value="{{ old('max_rooms', 50) }}" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <p class="mt-1 text-xs text-gray-600">0 = ilimitado</p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-800 mb-2">
                                ...
                                <input type="number" name="max_room_types" value="{{ old('max_room_types', 10) }}" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ...
                            <div>
                                ...
                                <input type="number" name="max_tables" value="{{ old('max_tables', 20) }}" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" disabled x-bind:disabled="true">
                            ...
                            <div>
                                ...
                                <input type="number" name="max_daily_hotel_reservations" value="{{ old('max_daily_hotel_reservations', 100) }}" min="0" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <p class="mt-1 text-xs text-gray-600">0 = ilimitado</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="inventory_tracking" value="1" {{ old('inventory_tracking', true) ? 'checked' : '' }} class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" id="inventory_tracking">
                ...
                <div class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="whatsapp_integration" value="1" {{ old('whatsapp_integration') ? 'checked' : '' }} class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" id="whatsapp_integration">
                ...
                {{-- KiuBot Asistente --}}
                <div class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="kiubot_enabled" value="1" {{ old('kiubot_enabled') ? 'checked' : '' }} class="w-5 h-5 text-purple-600 border-gray-300 rounded focus:ring-2 focus:ring-purple-500" id="kiubot_enabled">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="support_level" id="support_level" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('support_level') border-red-300 @enderror" required>
                            <option value="basic" {{ old('support_level') == 'basic' ? 'selected' : '' }}>Básico - Correo, horario laboral</option>
                            <option value="priority" {{ old('support_level') == 'priority' ? 'selected' : '' }}>Prioritario - Correo + Chat, respuesta rápida</option>
                            <option value="premium" {{ old('support_level') == 'premium' ? 'selected' : '' }}>Premium - 24/7, atención personalizada</option>
                        </select>
                        @error('support_level')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="allow_custom_slug" value="1" {{ old('allow_custom_slug') ? 'checked' : '' }} class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" id="allow_custom_slug">
                ...
                {{-- Plan Activo --}}
                <div class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" id="is_active">
                ...
                {{-- Plan Público --}}
                <div class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="is_public" value="1" {{ old('is_public', true) ? 'checked' : '' }} class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" id="is_public">
                ...
                {{-- Plan Destacado --}}
                <div class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <input type="checkbox" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500" id="is_featured">
...
function planForm() {
    return {
        monthlyPrice: {{ old('price', 49900) }},
        quarterlyDiscount: {{ old('discounts.quarterly', 5) }},
        semesterDiscount: {{ old('discounts.semester', 10) }},
        annualDiscount: {{ old('discounts.annual', 15) }},
        features: @json(old('features_list', ['Pagos online integrados', 'Reportes y analíticas básicas'])),
