...
@section('title', 'LinkiuDev - Nuevo Cliente')
...
<div class="container-fluid max-w-3xl">
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            <h1 class="text-lg font-bold text-gray-900 dark:text-white">Nuevo Cliente</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">Agrega un nuevo cliente de desarrollo</p>
        </div>
    </div>

    {{-- Formulario --}}
    <form action="{{ route('superlinkiu.linkiudev.clients.store') }}" method="POST" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    El número donde recibirá las notificaciones de WhatsApp
                </p>
            </div>
        ...
        <div class="flex justify-end gap-3 mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            <a href="{{ route('superlinkiu.linkiudev.clients.index') }}" class="px-4 py-2 text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                Cancelar
            </a>
