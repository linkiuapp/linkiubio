...
<div class="max-w-2xl mx-auto space-y-6 mt-6">
    <div class="flex items-center gap-3">
        ...
        <h1 class="text-lg font-semibold text-gray-800">Crear Nueva Categoría</h1>
    </div>

    <form action="{{ route('superlinkiu.tutorial-categories.store') }}" method="POST" class="bg-white rounded-lg border border-gray-200 p-6">
        @csrf
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea name="description" 
                          rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none">{{ old('description') }}</textarea>
            </div>
