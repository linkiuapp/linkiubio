...
@section('title', 'Editar Release Note')
...
<div class="max-w-6xl mx-auto space-y-6 mt-6" x-data="releaseNoteForm()">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-lg font-semibold text-gray-800">Editar Release Note</h1>
                <p class="text-sm text-gray-600 mt-1">v{{ $releaseNote->version }}</p>
            </div>
        </div>
    </div>
    {{-- End SECTION: Header --}}

    <form action="{{ route('superlinkiu.release-notes.update', $releaseNote) }}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="p-6 space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" 
                                       name="release_date" 
                                       value="{{ old('release_date', $releaseNote->release_date->format('Y-m-d')) }}"
                ...
                <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <input type="number" 
                                   name="order" 
                                   value="{{ old('order', $releaseNote->order) }}"
                                   min="0"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   id="is_current"
                                   value="1"
                                   {{ old('is_current', $releaseNote->is_current) ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   id="is_active"
                                   value="1"
                                   {{ old('is_active', $releaseNote->is_active) ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   id="notify_tenants"
                                   value="1"
                                   {{ old('notify_tenants', $releaseNote->notify_tenants) ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
