    ...
    <div class="min-h-screen">
        ...
        <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="text-center mb-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-3">Cuéntanos sobre tu Negocio</h2>
                <p class="text-base text-gray-600">Necesitamos verificar que tu negocio es real y cumple con nuestras políticas</p>
            </div>
            ...
            <form method="POST" action="{{ route('register.step2.store') }}" class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 lg:p-8 border-b border-gray-200">
                    ...
                    <div>
                        ...
                        <select name="business_category_id"
                                class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none @error('business_category_id') border-red-300 @enderror text-base"
                                required>
                            <option value="">Selecciona la categoría de tu negocio</option>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none @error('business_name') border-red-300 @enderror"
                        ...
                        <div>
                            ...
                            <select name="document_type"
                                    class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none @error('document_type') border-red-300 @enderror"
                                    required>
                        ...
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none @error('document_number') border-red-300 @enderror"
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="phone"
                                   value="{{ old('phone') }}"
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none @error('phone') border-red-300 @enderror"
                        ...
                        <div>
                            ...
                            <input type="email"
                                   name="email"
                                   value="{{ old('email') }}"
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none @error('email') border-red-300 @enderror"
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="city"
                                   value="{{ old('city') }}"
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none @error('city') border-red-300 @enderror"
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="address"
                                   value="{{ old('address') }}"
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none @error('address') border-red-300 @enderror"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description"
                                      rows="3"
                                      class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none @error('description') border-red-300 @enderror"
                ...
                <div class="p-6 lg:p-8 bg-blue-50 border-t border-blue-100">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="font-semibold text-gray-900 mb-1">Verificación de Seguridad</h4>
                ...
                <div class="p-6 lg:p-8 bg-gray-50 flex items-center justify-between">
