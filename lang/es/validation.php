...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'max_categories' => 'máximo de categorías',
        'max_variables' => 'máximo de variables',
        'max_product_images' => 'máximo de imágenes por producto',
        'max_slider' => 'máximo de banners',
        'max_active_coupons' => 'máximo de cupones activos',
        'max_sedes' => 'máximo de sedes',
        'max_delivery_zones' => 'máximo de zonas de reparto',
        'max_payment_methods' => 'máximo de métodos de pago',
        'max_bank_accounts' => 'máximo de cuentas bancarias',
        'max_admins' => 'máximo de administradores',
        'max_tickets_per_month' => 'máximo de tickets por mes',
        'order_history_months' => 'meses de retención de pedidos',
        'analytics_retention_days' => 'días de retención de analíticas',
        'max_tables' => 'máximo de mesas',
        'max_daily_reservations' => 'máximo de reservas diarias',
        'max_rooms' => 'máximo de habitaciones',
        'max_room_types' => 'máximo de tipos de habitación',
        'max_daily_hotel_reservations' => 'máximo de reservas de hotel por día',
        'support_level' => 'nivel de soporte',
        'support_response_time' => 'tiempo de respuesta de soporte',
    ],
