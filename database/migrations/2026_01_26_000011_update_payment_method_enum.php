...
return new class extends Migration
{
    ...
    {
        // Actualizar enum en personal_finance_payments
        DB::statement("ALTER TABLE `personal_finance_payments` MODIFY COLUMN `payment_method` ENUM('transfer', 'cash', 'account_bank', 'card', 'nequi', 'daviplata', 'other') DEFAULT 'transfer'");
    ...
    {
        DB::statement("ALTER TABLE `personal_finance_payments` MODIFY COLUMN `payment_method` ENUM('transfer', 'cash', 'card', 'nequi', 'daviplata', 'other') DEFAULT 'transfer'");
